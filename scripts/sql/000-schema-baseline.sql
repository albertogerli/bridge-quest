...
CREATE TABLE IF NOT EXISTS public.live_tables (
  ...
  sessione_id uuid,
  numero integer,
  in_attesa jsonb NOT NULL,
  partecipazioni jsonb NOT NULL
);
...
CREATE OR REPLACE FUNCTION public.aste_giocatore_torneo(p_torneo uuid, p_giocatore uuid)
 RETURNS jsonb
 LANGUAGE sql
 STABLE SECURITY DEFINER
 SET search_path TO ''
...
begin
  ...
  -- FUSIONE, non ricostruzione: chi non è seduto conserva il suo conteggio.
  select v_part || coalesce(jsonb_object_agg(s.key, coalesce((v_part ->> s.key)::int, 0) + 1), '{}'::jsonb)
    into v_part
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    -- Chi siede dove lo vedono anche gli allievi: e' il presupposto della
    -- scelta del posto.
    'seatOf', coalesce(t.seat_of, '{}'::jsonb),
    'inAttesa', coalesce(t.in_attesa, '[]'::jsonb),
    'maniAlTurno', public.aula_mani_al_turno(t.id, auth.uid()),
    'prossimoAUscire', public.aula_prossimo_a_uscire(t.id),
...
ALTER TABLE public.live_tables ALTER COLUMN in_attesa SET DEFAULT '[]'::jsonb;
ALTER TABLE public.live_tables ALTER COLUMN partecipazioni SET DEFAULT '{}'::jsonb;
...
-- COLONNE IDENTITY
ALTER TABLE public.email_events ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (SEQUENCE NAME public.email_events_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 NO CYCLE);
ALTER TABLE public.forum_poll_votes ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (SEQUENCE NAME public.forum_poll_votes_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 NO CYCLE);
ALTER TABLE public.friendships ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (SEQUENCE NAME public.friendships_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 NO CYCLE);
ALTER TABLE public.push_subscriptions ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (SEQUENCE NAME public.push_subscriptions_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 NO CYCLE);
...
CREATE INDEX tornei_tipo_chiusura_idx ON public.tornei USING btree (tipo, chiude_at DESC);
...
CREATE POLICY "Ognuno legge il proprio risultato di torneo" ON public.risultati_torneo AS PERMISSIVE FOR SELECT TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
...
-- PERMESSI ESATTI: TABELLE, COLONNE, SEQUENZE
REVOKE ALL ON TABLE public.adesioni FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.asd FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.asd_clubs FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON SEQUENCE public.asd_id_seq FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.assignments FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.badges FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON SEQUENCE public.badges_id_seq FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.bbo_username_cleanup_2026_08 FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.bidding_sessions FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.challenges FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.class_members FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.class_messages FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.classes FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.club_posts FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.coda_sfide_coppie FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.collectible_cards FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.completed_modules FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON SEQUENCE public.completed_modules_id_seq FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.course_worlds FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.courses FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.elenco_allievi FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.email_events FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON SEQUENCE public.email_events_id_seq FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.esercizi_posizione FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.eserciziario_exercises FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.forum_comments FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON SEQUENCE public.forum_comments_id_seq FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.forum_likes FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON SEQUENCE public.forum_likes_id_seq FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.forum_poll_votes FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON SEQUENCE public.forum_poll_votes_id_seq FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.forum_posts FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON SEQUENCE public.forum_posts_id_seq FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.friendships FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON SEQUENCE public.friendships_id_seq FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.game_results FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.glossary FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.guided_hands FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.instructor_requests FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.inviti_aula FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.lesson_modules FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.lessons FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.libreria FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.live_tables FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.login_history FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.mani_generate FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.modelli_mani FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.note_smazzate FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.partner_profiles FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.posizioni_preferite FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.presenze FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON SEQUENCE public.review_items_id_seq FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.risposte_sondaggio FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.risultati_mano FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON TABLE public.sfide_coppie FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.smazzate FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.sondaggi FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.tornei FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.torneo_mani FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.tournament_results FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.traduzioni_stato FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.trova_errore_scenarios FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON TABLE public.weekly_challenges FROM PUBLIC, anon, authenticated, service_role;
GRANT DELETE ON TABLE public.adesioni TO anon;
GRANT INSERT ON TABLE public.adesioni TO anon;
GRANT MAINTAIN ON TABLE public.adesioni TO anon;
GRANT REFERENCES ON TABLE public.adesioni TO anon;
GRANT SELECT ON TABLE public.adesioni TO anon;
GRANT TRIGGER ON TABLE public.adesioni TO anon;
GRANT TRUNCATE ON TABLE public.adesioni TO anon;
GRANT UPDATE ON TABLE public.adesioni TO anon;
GRANT DELETE ON TABLE public.adesioni TO authenticated;
GRANT INSERT ON TABLE public.adesioni TO authenticated;
GRANT MAINTAIN ON TABLE public.adesioni TO authenticated;
GRANT REFERENCES ON TABLE public.adesioni TO authenticated;
GRANT SELECT ON TABLE public.adesioni TO authenticated;
GRANT TRIGGER ON TABLE public.adesioni TO authenticated;
GRANT TRUNCATE ON TABLE public.adesioni TO authenticated;
GRANT UPDATE ON TABLE public.adesioni TO authenticated;
GRANT DELETE ON TABLE public.adesioni TO service_role;
GRANT INSERT ON TABLE public.adesioni TO service_role;
GRANT MAINTAIN ON TABLE public.adesioni TO service_role;
GRANT REFERENCES ON TABLE public.adesioni TO service_role;
GRANT SELECT ON TABLE public.adesioni TO service_role;
GRANT TRIGGER ON TABLE public.adesioni TO service_role;
GRANT TRUNCATE ON TABLE public.adesioni TO service_role;
GRANT UPDATE ON TABLE public.adesioni TO service_role;
GRANT DELETE ON TABLE public.asd TO anon;
GRANT INSERT ON TABLE public.asd TO anon;
GRANT MAINTAIN ON TABLE public.asd TO anon;
...
GRANT MAINTAIN ON TABLE public.asd TO authenticated;
...
GRANT MAINTAIN ON TABLE public.asd TO service_role;
...
GRANT DELETE ON TABLE public.asd_clubs TO anon;
GRANT INSERT ON TABLE public.asd_clubs TO anon;
GRANT MAINTAIN ON TABLE public.asd_clubs TO anon;
GRANT REFERENCES ON TABLE public.asd_clubs TO anon;
GRANT SELECT ON TABLE public.asd_clubs TO anon;
GRANT TRIGGER ON TABLE public.asd_clubs TO anon;
GRANT TRUNCATE ON TABLE public.asd_clubs TO anon;
GRANT UPDATE ON TABLE public.asd_clubs TO anon;
GRANT DELETE ON TABLE public.asd_clubs TO authenticated;
GRANT INSERT ON TABLE public.asd_clubs TO authenticated;
GRANT MAINTAIN ON TABLE public.asd_clubs TO authenticated;
GRANT REFERENCES ON TABLE public.asd_clubs TO authenticated;
GRANT SELECT ON TABLE public.asd_clubs TO authenticated;
GRANT TRIGGER ON TABLE public.asd_clubs TO authenticated;
GRANT TRUNCATE ON TABLE public.asd_clubs TO authenticated;
GRANT UPDATE ON TABLE public.asd_clubs TO authenticated;
GRANT DELETE ON TABLE public.asd_clubs TO service_role;
GRANT INSERT ON TABLE public.asd_clubs TO service_role;
GRANT MAINTAIN ON TABLE public.asd_clubs TO service_role;
GRANT REFERENCES ON TABLE public.asd_clubs TO service_role;
GRANT SELECT ON TABLE public.asd_clubs TO service_role;
GRANT TRIGGER ON TABLE public.asd_clubs TO service_role;
GRANT TRUNCATE ON TABLE public.asd_clubs TO service_role;
GRANT UPDATE ON TABLE public.asd_clubs TO service_role;
GRANT SELECT ON SEQUENCE public.asd_id_seq TO anon;
GRANT UPDATE ON SEQUENCE public.asd_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.asd_id_seq TO anon;
GRANT SELECT ON SEQUENCE public.asd_id_seq TO authenticated;
GRANT UPDATE ON SEQUENCE public.asd_id_seq TO authenticated;
GRANT USAGE ON SEQUENCE public.asd_id_seq TO authenticated;
GRANT SELECT ON SEQUENCE public.asd_id_seq TO service_role;
GRANT UPDATE ON SEQUENCE public.asd_id_seq TO service_role;
GRANT USAGE ON SEQUENCE public.asd_id_seq TO service_role;
GRANT DELETE ON TABLE public.assignments TO anon;
GRANT INSERT ON TABLE public.assignments TO anon;
GRANT MAINTAIN ON TABLE public.assignments TO anon;
...
GRANT MAINTAIN ON TABLE public.assignments TO authenticated;
...
GRANT MAINTAIN ON TABLE public.assignments TO service_role;
...
GRANT MAINTAIN ON TABLE public.badges TO anon;
...
GRANT MAINTAIN ON TABLE public.badges TO authenticated;
...
GRANT MAINTAIN ON TABLE public.badges TO service_role;
...
GRANT SELECT ON SEQUENCE public.badges_id_seq TO anon;
GRANT UPDATE ON SEQUENCE public.badges_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.badges_id_seq TO anon;
GRANT SELECT ON SEQUENCE public.badges_id_seq TO authenticated;
GRANT UPDATE ON SEQUENCE public.badges_id_seq TO authenticated;
GRANT USAGE ON SEQUENCE public.badges_id_seq TO authenticated;
GRANT SELECT ON SEQUENCE public.badges_id_seq TO service_role;
GRANT UPDATE ON SEQUENCE public.badges_id_seq TO service_role;
GRANT USAGE ON SEQUENCE public.badges_id_seq TO service_role;
GRANT DELETE ON TABLE public.bbo_username_cleanup_2026_08 TO anon;
GRANT INSERT ON TABLE public.bbo_username_cleanup_2026_08 TO anon;
GRANT MAINTAIN ON TABLE public.bbo_username_cleanup_2026_08 TO anon;
GRANT REFERENCES ON TABLE public.bbo_username_cleanup_2026_08 TO anon;
GRANT SELECT ON TABLE public.bbo_username_cleanup_2026_08 TO anon;
GRANT TRIGGER ON TABLE public.bbo_username_cleanup_2026_08 TO anon;
GRANT TRUNCATE ON TABLE public.bbo_username_cleanup_2026_08 TO anon;
GRANT UPDATE ON TABLE public.bbo_username_cleanup_2026_08 TO anon;
GRANT DELETE ON TABLE public.bbo_username_cleanup_2026_08 TO authenticated;
GRANT INSERT ON TABLE public.bbo_username_cleanup_2026_08 TO authenticated;
GRANT MAINTAIN ON TABLE public.bbo_username_cleanup_2026_08 TO authenticated;
GRANT REFERENCES ON TABLE public.bbo_username_cleanup_2026_08 TO authenticated;
GRANT SELECT ON TABLE public.bbo_username_cleanup_2026_08 TO authenticated;
GRANT TRIGGER ON TABLE public.bbo_username_cleanup_2026_08 TO authenticated;
GRANT TRUNCATE ON TABLE public.bbo_username_cleanup_2026_08 TO authenticated;
GRANT UPDATE ON TABLE public.bbo_username_cleanup_2026_08 TO authenticated;
GRANT DELETE ON TABLE public.bbo_username_cleanup_2026_08 TO service_role;
GRANT INSERT ON TABLE public.bbo_username_cleanup_2026_08 TO service_role;
GRANT MAINTAIN ON TABLE public.bbo_username_cleanup_2026_08 TO service_role;
GRANT REFERENCES ON TABLE public.bbo_username_cleanup_2026_08 TO service_role;
GRANT SELECT ON TABLE public.bbo_username_cleanup_2026_08 TO service_role;
GRANT TRIGGER ON TABLE public.bbo_username_cleanup_2026_08 TO service_role;
GRANT TRUNCATE ON TABLE public.bbo_username_cleanup_2026_08 TO service_role;
GRANT UPDATE ON TABLE public.bbo_username_cleanup_2026_08 TO service_role;
GRANT DELETE ON TABLE public.bidding_sessions TO anon;
GRANT INSERT ON TABLE public.bidding_sessions TO anon;
GRANT MAINTAIN ON TABLE public.bidding_sessions TO anon;
GRANT REFERENCES ON TABLE public.bidding_sessions TO anon;
GRANT SELECT ON TABLE public.bidding_sessions TO anon;
GRANT TRIGGER ON TABLE public.bidding_sessions TO anon;
GRANT TRUNCATE ON TABLE public.bidding_sessions TO anon;
GRANT UPDATE ON TABLE public.bidding_sessions TO anon;
GRANT DELETE ON TABLE public.bidding_sessions TO authenticated;
GRANT INSERT ON TABLE public.bidding_sessions TO authenticated;
GRANT MAINTAIN ON TABLE public.bidding_sessions TO authenticated;
GRANT REFERENCES ON TABLE public.bidding_sessions TO authenticated;
GRANT SELECT ON TABLE public.bidding_sessions TO authenticated;
GRANT TRIGGER ON TABLE public.bidding_sessions TO authenticated;
GRANT TRUNCATE ON TABLE public.bidding_sessions TO authenticated;
GRANT UPDATE ON TABLE public.bidding_sessions TO authenticated;
GRANT DELETE ON TABLE public.bidding_sessions TO service_role;
GRANT INSERT ON TABLE public.bidding_sessions TO service_role;
GRANT MAINTAIN ON TABLE public.bidding_sessions TO service_role;
GRANT REFERENCES ON TABLE public.bidding_sessions TO service_role;
GRANT SELECT ON TABLE public.bidding_sessions TO service_role;
GRANT TRIGGER ON TABLE public.bidding_sessions TO service_role;
GRANT TRUNCATE ON TABLE public.bidding_sessions TO service_role;
GRANT UPDATE ON TABLE public.bidding_sessions TO service_role;
GRANT DELETE ON TABLE public.challenges TO anon;
GRANT INSERT ON TABLE public.challenges TO anon;
GRANT MAINTAIN ON TABLE public.challenges TO anon;
...
GRANT MAINTAIN ON TABLE public.challenges TO authenticated;
...
GRANT MAINTAIN ON TABLE public.challenges TO service_role;
...
GRANT MAINTAIN ON TABLE public.class_members TO anon;
...
GRANT MAINTAIN ON TABLE public.class_members TO authenticated;
...
GRANT MAINTAIN ON TABLE public.class_members TO service_role;
...
GRANT DELETE ON TABLE public.class_messages TO anon;
GRANT INSERT ON TABLE public.class_messages TO anon;
GRANT MAINTAIN ON TABLE public.class_messages TO anon;
GRANT REFERENCES ON TABLE public.class_messages TO anon;
GRANT SELECT ON TABLE public.class_messages TO anon;
GRANT TRIGGER ON TABLE public.class_messages TO anon;
GRANT TRUNCATE ON TABLE public.class_messages TO anon;
GRANT UPDATE ON TABLE public.class_messages TO anon;
GRANT DELETE ON TABLE public.class_messages TO authenticated;
GRANT INSERT ON TABLE public.class_messages TO authenticated;
GRANT MAINTAIN ON TABLE public.class_messages TO authenticated;
GRANT REFERENCES ON TABLE public.class_messages TO authenticated;
GRANT SELECT ON TABLE public.class_messages TO authenticated;
GRANT TRIGGER ON TABLE public.class_messages TO authenticated;
GRANT TRUNCATE ON TABLE public.class_messages TO authenticated;
GRANT UPDATE ON TABLE public.class_messages TO authenticated;
GRANT DELETE ON TABLE public.class_messages TO service_role;
GRANT INSERT ON TABLE public.class_messages TO service_role;
GRANT MAINTAIN ON TABLE public.class_messages TO service_role;
GRANT REFERENCES ON TABLE public.class_messages TO service_role;
GRANT SELECT ON TABLE public.class_messages TO service_role;
GRANT TRIGGER ON TABLE public.class_messages TO service_role;
GRANT TRUNCATE ON TABLE public.class_messages TO service_role;
GRANT UPDATE ON TABLE public.class_messages TO service_role;
...
GRANT DELETE ON TABLE public.club_posts TO anon;
GRANT INSERT ON TABLE public.club_posts TO anon;
GRANT MAINTAIN ON TABLE public.club_posts TO anon;
GRANT REFERENCES ON TABLE public.club_posts TO anon;
GRANT SELECT ON TABLE public.club_posts TO anon;
GRANT TRIGGER ON TABLE public.club_posts TO anon;
GRANT TRUNCATE ON TABLE public.club_posts TO anon;
GRANT UPDATE ON TABLE public.club_posts TO anon;
GRANT DELETE ON TABLE public.club_posts TO authenticated;
GRANT INSERT ON TABLE public.club_posts TO authenticated;
GRANT MAINTAIN ON TABLE public.club_posts TO authenticated;
GRANT REFERENCES ON TABLE public.club_posts TO authenticated;
GRANT SELECT ON TABLE public.club_posts TO authenticated;
GRANT TRIGGER ON TABLE public.club_posts TO authenticated;
GRANT TRUNCATE ON TABLE public.club_posts TO authenticated;
GRANT UPDATE ON TABLE public.club_posts TO authenticated;
GRANT DELETE ON TABLE public.club_posts TO service_role;
GRANT INSERT ON TABLE public.club_posts TO service_role;
GRANT MAINTAIN ON TABLE public.club_posts TO service_role;
GRANT REFERENCES ON TABLE public.club_posts TO service_role;
GRANT SELECT ON TABLE public.club_posts TO service_role;
GRANT TRIGGER ON TABLE public.club_posts TO service_role;
GRANT TRUNCATE ON TABLE public.club_posts TO service_role;
GRANT UPDATE ON TABLE public.club_posts TO service_role;
GRANT DELETE ON TABLE public.coda_sfide_coppie TO anon;
GRANT INSERT ON TABLE public.coda_sfide_coppie TO anon;
GRANT MAINTAIN ON TABLE public.coda_sfide_coppie TO anon;
GRANT REFERENCES ON TABLE public.coda_sfide_coppie TO anon;
GRANT SELECT ON TABLE public.coda_sfide_coppie TO anon;
GRANT TRIGGER ON TABLE public.coda_sfide_coppie TO anon;
GRANT TRUNCATE ON TABLE public.coda_sfide_coppie TO anon;
GRANT UPDATE ON TABLE public.coda_sfide_coppie TO anon;
GRANT DELETE ON TABLE public.coda_sfide_coppie TO authenticated;
GRANT INSERT ON TABLE public.coda_sfide_coppie TO authenticated;
GRANT MAINTAIN ON TABLE public.coda_sfide_coppie TO authenticated;
GRANT REFERENCES ON TABLE public.coda_sfide_coppie TO authenticated;
GRANT SELECT ON TABLE public.coda_sfide_coppie TO authenticated;
GRANT TRIGGER ON TABLE public.coda_sfide_coppie TO authenticated;
GRANT TRUNCATE ON TABLE public.coda_sfide_coppie TO authenticated;
GRANT UPDATE ON TABLE public.coda_sfide_coppie TO authenticated;
GRANT DELETE ON TABLE public.coda_sfide_coppie TO service_role;
GRANT INSERT ON TABLE public.coda_sfide_coppie TO service_role;
GRANT MAINTAIN ON TABLE public.coda_sfide_coppie TO service_role;
GRANT REFERENCES ON TABLE public.coda_sfide_coppie TO service_role;
GRANT SELECT ON TABLE public.coda_sfide_coppie TO service_role;
GRANT TRIGGER ON TABLE public.coda_sfide_coppie TO service_role;
GRANT TRUNCATE ON TABLE public.coda_sfide_coppie TO service_role;
GRANT UPDATE ON TABLE public.coda_sfide_coppie TO service_role;
GRANT DELETE ON TABLE public.collectible_cards TO anon;
GRANT INSERT ON TABLE public.collectible_cards TO anon;
GRANT MAINTAIN ON TABLE public.collectible_cards TO anon;
GRANT REFERENCES ON TABLE public.collectible_cards TO anon;
GRANT SELECT ON TABLE public.collectible_cards TO anon;
GRANT TRIGGER ON TABLE public.collectible_cards TO anon;
GRANT TRUNCATE ON TABLE public.collectible_cards TO anon;
GRANT UPDATE ON TABLE public.collectible_cards TO anon;
GRANT DELETE ON TABLE public.collectible_cards TO authenticated;
GRANT INSERT ON TABLE public.collectible_cards TO authenticated;
GRANT MAINTAIN ON TABLE public.collectible_cards TO authenticated;
GRANT REFERENCES ON TABLE public.collectible_cards TO authenticated;
GRANT SELECT ON TABLE public.collectible_cards TO authenticated;
GRANT TRIGGER ON TABLE public.collectible_cards TO authenticated;
GRANT TRUNCATE ON TABLE public.collectible_cards TO authenticated;
GRANT UPDATE ON TABLE public.collectible_cards TO authenticated;
GRANT DELETE ON TABLE public.collectible_cards TO service_role;
GRANT INSERT ON TABLE public.collectible_cards TO service_role;
GRANT MAINTAIN ON TABLE public.collectible_cards TO service_role;
GRANT REFERENCES ON TABLE public.collectible_cards TO service_role;
GRANT SELECT ON TABLE public.collectible_cards TO service_role;
GRANT TRIGGER ON TABLE public.collectible_cards TO service_role;
GRANT TRUNCATE ON TABLE public.collectible_cards TO service_role;
GRANT UPDATE ON TABLE public.collectible_cards TO service_role;
GRANT DELETE ON TABLE public.completed_modules TO anon;
GRANT INSERT ON TABLE public.completed_modules TO anon;
GRANT MAINTAIN ON TABLE public.completed_modules TO anon;
GRANT REFERENCES ON TABLE public.completed_modules TO anon;
GRANT SELECT ON TABLE public.completed_modules TO anon;
GRANT TRIGGER ON TABLE public.completed_modules TO anon;
GRANT TRUNCATE ON TABLE public.completed_modules TO anon;
GRANT UPDATE ON TABLE public.completed_modules TO anon;
GRANT DELETE ON TABLE public.completed_modules TO authenticated;
GRANT INSERT ON TABLE public.completed_modules TO authenticated;
GRANT MAINTAIN ON TABLE public.completed_modules TO authenticated;
GRANT REFERENCES ON TABLE public.completed_modules TO authenticated;
GRANT SELECT ON TABLE public.completed_modules TO authenticated;
GRANT TRIGGER ON TABLE public.completed_modules TO authenticated;
GRANT TRUNCATE ON TABLE public.completed_modules TO authenticated;
GRANT UPDATE ON TABLE public.completed_modules TO authenticated;
GRANT DELETE ON TABLE public.completed_modules TO service_role;
GRANT INSERT ON TABLE public.completed_modules TO service_role;
GRANT MAINTAIN ON TABLE public.completed_modules TO service_role;
GRANT REFERENCES ON TABLE public.completed_modules TO service_role;
GRANT SELECT ON TABLE public.completed_modules TO service_role;
GRANT TRIGGER ON TABLE public.completed_modules TO service_role;
GRANT TRUNCATE ON TABLE public.completed_modules TO service_role;
GRANT UPDATE ON TABLE public.completed_modules TO service_role;
GRANT SELECT ON SEQUENCE public.completed_modules_id_seq TO anon;
GRANT UPDATE ON SEQUENCE public.completed_modules_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.completed_modules_id_seq TO anon;
GRANT SELECT ON SEQUENCE public.completed_modules_id_seq TO authenticated;
GRANT UPDATE ON SEQUENCE public.completed_modules_id_seq TO authenticated;
GRANT USAGE ON SEQUENCE public.completed_modules_id_seq TO authenticated;
GRANT SELECT ON SEQUENCE public.completed_modules_id_seq TO service_role;
GRANT UPDATE ON SEQUENCE public.completed_modules_id_seq TO service_role;
GRANT USAGE ON SEQUENCE public.completed_modules_id_seq TO service_role;
GRANT DELETE ON TABLE public.course_worlds TO anon;
GRANT INSERT ON TABLE public.course_worlds TO anon;
GRANT MAINTAIN ON TABLE public.course_worlds TO anon;
GRANT REFERENCES ON TABLE public.course_worlds TO anon;
GRANT SELECT ON TABLE public.course_worlds TO anon;
GRANT TRIGGER ON TABLE public.course_worlds TO anon;
GRANT TRUNCATE ON TABLE public.course_worlds TO anon;
GRANT UPDATE ON TABLE public.course_worlds TO anon;
GRANT DELETE ON TABLE public.course_worlds TO authenticated;
GRANT INSERT ON TABLE public.course_worlds TO authenticated;
GRANT MAINTAIN ON TABLE public.course_worlds TO authenticated;
GRANT REFERENCES ON TABLE public.course_worlds TO authenticated;
GRANT SELECT ON TABLE public.course_worlds TO authenticated;
GRANT TRIGGER ON TABLE public.course_worlds TO authenticated;
GRANT TRUNCATE ON TABLE public.course_worlds TO authenticated;
GRANT UPDATE ON TABLE public.course_worlds TO authenticated;
GRANT DELETE ON TABLE public.course_worlds TO service_role;
GRANT INSERT ON TABLE public.course_worlds TO service_role;
GRANT MAINTAIN ON TABLE public.course_worlds TO service_role;
GRANT REFERENCES ON TABLE public.course_worlds TO service_role;
GRANT SELECT ON TABLE public.course_worlds TO service_role;
GRANT TRIGGER ON TABLE public.course_worlds TO service_role;
GRANT TRUNCATE ON TABLE public.course_worlds TO service_role;
GRANT UPDATE ON TABLE public.course_worlds TO service_role;
...
GRANT DELETE ON TABLE public.elenco_allievi TO anon;
GRANT INSERT ON TABLE public.elenco_allievi TO anon;
GRANT MAINTAIN ON TABLE public.elenco_allievi TO anon;
GRANT REFERENCES ON TABLE public.elenco_allievi TO anon;
GRANT SELECT ON TABLE public.elenco_allievi TO anon;
GRANT TRIGGER ON TABLE public.elenco_allievi TO anon;
GRANT TRUNCATE ON TABLE public.elenco_allievi TO anon;
GRANT UPDATE ON TABLE public.elenco_allievi TO anon;
GRANT DELETE ON TABLE public.elenco_allievi TO authenticated;
GRANT INSERT ON TABLE public.elenco_allievi TO authenticated;
GRANT MAINTAIN ON TABLE public.elenco_allievi TO authenticated;
GRANT REFERENCES ON TABLE public.elenco_allievi TO authenticated;
GRANT SELECT ON TABLE public.elenco_allievi TO authenticated;
GRANT TRIGGER ON TABLE public.elenco_allievi TO authenticated;
GRANT TRUNCATE ON TABLE public.elenco_allievi TO authenticated;
GRANT UPDATE ON TABLE public.elenco_allievi TO authenticated;
GRANT DELETE ON TABLE public.elenco_allievi TO service_role;
GRANT INSERT ON TABLE public.elenco_allievi TO service_role;
GRANT MAINTAIN ON TABLE public.elenco_allievi TO service_role;
GRANT REFERENCES ON TABLE public.elenco_allievi TO service_role;
GRANT SELECT ON TABLE public.elenco_allievi TO service_role;
GRANT TRIGGER ON TABLE public.elenco_allievi TO service_role;
GRANT TRUNCATE ON TABLE public.elenco_allievi TO service_role;
GRANT UPDATE ON TABLE public.elenco_allievi TO service_role;
GRANT DELETE ON TABLE public.email_events TO anon;
GRANT INSERT ON TABLE public.email_events TO anon;
GRANT MAINTAIN ON TABLE public.email_events TO anon;
...
GRANT MAINTAIN ON TABLE public.email_events TO authenticated;
...
GRANT MAINTAIN ON TABLE public.email_events TO service_role;
...
GRANT SELECT ON SEQUENCE public.email_events_id_seq TO anon;
GRANT UPDATE ON SEQUENCE public.email_events_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.email_events_id_seq TO anon;
GRANT SELECT ON SEQUENCE public.email_events_id_seq TO authenticated;
GRANT UPDATE ON SEQUENCE public.email_events_id_seq TO authenticated;
GRANT USAGE ON SEQUENCE public.email_events_id_seq TO authenticated;
GRANT SELECT ON SEQUENCE public.email_events_id_seq TO service_role;
GRANT UPDATE ON SEQUENCE public.email_events_id_seq TO service_role;
GRANT USAGE ON SEQUENCE public.email_events_id_seq TO service_role;
GRANT DELETE ON TABLE public.esercizi_posizione TO anon;
...
GRANT DELETE ON TABLE public.esercizi_posizione TO authenticated;
...
GRANT DELETE ON TABLE public.esercizi_posizione TO service_role;
GRANT INSERT ON TABLE public.esercizi_posizione TO service_role;
GRANT MAINTAIN ON TABLE public.esercizi_posizione TO service_role;
GRANT REFERENCES ON TABLE public.esercizi_posizione TO service_role;
GRANT SELECT ON TABLE public.esercizi_posizione TO service_role;
GRANT TRIGGER ON TABLE public.esercizi_posizione TO service_role;
GRANT TRUNCATE ON TABLE public.esercizi_posizione TO service_role;
GRANT UPDATE ON TABLE public.esercizi_posizione TO service_role;
GRANT DELETE ON TABLE public.eserciziario_exercises TO anon;
GRANT INSERT ON TABLE public.eserciziario_exercises TO anon;
GRANT MAINTAIN ON TABLE public.eserciziario_exercises TO anon;
GRANT REFERENCES ON TABLE public.eserciziario_exercises TO anon;
GRANT SELECT ON TABLE public.eserciziario_exercises TO anon;
GRANT TRIGGER ON TABLE public.eserciziario_exercises TO anon;
GRANT TRUNCATE ON TABLE public.eserciziario_exercises TO anon;
GRANT UPDATE ON TABLE public.eserciziario_exercises TO anon;
GRANT DELETE ON TABLE public.eserciziario_exercises TO authenticated;
GRANT INSERT ON TABLE public.eserciziario_exercises TO authenticated;
GRANT MAINTAIN ON TABLE public.eserciziario_exercises TO authenticated;
GRANT REFERENCES ON TABLE public.eserciziario_exercises TO authenticated;
GRANT SELECT ON TABLE public.eserciziario_exercises TO authenticated;
GRANT TRIGGER ON TABLE public.eserciziario_exercises TO authenticated;
GRANT TRUNCATE ON TABLE public.eserciziario_exercises TO authenticated;
GRANT UPDATE ON TABLE public.eserciziario_exercises TO authenticated;
GRANT DELETE ON TABLE public.eserciziario_exercises TO service_role;
GRANT INSERT ON TABLE public.eserciziario_exercises TO service_role;
GRANT MAINTAIN ON TABLE public.eserciziario_exercises TO service_role;
GRANT REFERENCES ON TABLE public.eserciziario_exercises TO service_role;
GRANT SELECT ON TABLE public.eserciziario_exercises TO service_role;
GRANT TRIGGER ON TABLE public.eserciziario_exercises TO service_role;
GRANT TRUNCATE ON TABLE public.eserciziario_exercises TO service_role;
GRANT UPDATE ON TABLE public.eserciziario_exercises TO service_role;
GRANT DELETE ON TABLE public.forum_comments TO anon;
GRANT INSERT ON TABLE public.forum_comments TO anon;
GRANT MAINTAIN ON TABLE public.forum_comments TO anon;
...
GRANT MAINTAIN ON TABLE public.forum_comments TO authenticated;
...
GRANT MAINTAIN ON TABLE public.forum_comments TO service_role;
...
GRANT SELECT ON SEQUENCE public.forum_comments_id_seq TO anon;
GRANT UPDATE ON SEQUENCE public.forum_comments_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.forum_comments_id_seq TO anon;
GRANT SELECT ON SEQUENCE public.forum_comments_id_seq TO authenticated;
GRANT UPDATE ON SEQUENCE public.forum_comments_id_seq TO authenticated;
GRANT USAGE ON SEQUENCE public.forum_comments_id_seq TO authenticated;
GRANT SELECT ON SEQUENCE public.forum_comments_id_seq TO service_role;
GRANT UPDATE ON SEQUENCE public.forum_comments_id_seq TO service_role;
GRANT USAGE ON SEQUENCE public.forum_comments_id_seq TO service_role;
GRANT DELETE ON TABLE public.forum_likes TO anon;
GRANT INSERT ON TABLE public.forum_likes TO anon;
GRANT MAINTAIN ON TABLE public.forum_likes TO anon;
...
GRANT MAINTAIN ON TABLE public.forum_likes TO authenticated;
...
GRANT MAINTAIN ON TABLE public.forum_likes TO service_role;
...
GRANT SELECT ON SEQUENCE public.forum_likes_id_seq TO anon;
GRANT UPDATE ON SEQUENCE public.forum_likes_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.forum_likes_id_seq TO anon;
GRANT SELECT ON SEQUENCE public.forum_likes_id_seq TO authenticated;
GRANT UPDATE ON SEQUENCE public.forum_likes_id_seq TO authenticated;
GRANT USAGE ON SEQUENCE public.forum_likes_id_seq TO authenticated;
GRANT SELECT ON SEQUENCE public.forum_likes_id_seq TO service_role;
GRANT UPDATE ON SEQUENCE public.forum_likes_id_seq TO service_role;
GRANT USAGE ON SEQUENCE public.forum_likes_id_seq TO service_role;
GRANT DELETE ON TABLE public.forum_poll_votes TO anon;
GRANT INSERT ON TABLE public.forum_poll_votes TO anon;
GRANT MAINTAIN ON TABLE public.forum_poll_votes TO anon;
GRANT REFERENCES ON TABLE public.forum_poll_votes TO anon;
GRANT SELECT ON TABLE public.forum_poll_votes TO anon;
GRANT TRIGGER ON TABLE public.forum_poll_votes TO anon;
GRANT TRUNCATE ON TABLE public.forum_poll_votes TO anon;
GRANT UPDATE ON TABLE public.forum_poll_votes TO anon;
GRANT DELETE ON TABLE public.forum_poll_votes TO authenticated;
GRANT INSERT ON TABLE public.forum_poll_votes TO authenticated;
GRANT MAINTAIN ON TABLE public.forum_poll_votes TO authenticated;
GRANT REFERENCES ON TABLE public.forum_poll_votes TO authenticated;
GRANT SELECT ON TABLE public.forum_poll_votes TO authenticated;
GRANT TRIGGER ON TABLE public.forum_poll_votes TO authenticated;
GRANT TRUNCATE ON TABLE public.forum_poll_votes TO authenticated;
GRANT UPDATE ON TABLE public.forum_poll_votes TO authenticated;
GRANT DELETE ON TABLE public.forum_poll_votes TO service_role;
GRANT INSERT ON TABLE public.forum_poll_votes TO service_role;
GRANT MAINTAIN ON TABLE public.forum_poll_votes TO service_role;
GRANT REFERENCES ON TABLE public.forum_poll_votes TO service_role;
GRANT SELECT ON TABLE public.forum_poll_votes TO service_role;
GRANT TRIGGER ON TABLE public.forum_poll_votes TO service_role;
GRANT TRUNCATE ON TABLE public.forum_poll_votes TO service_role;
GRANT UPDATE ON TABLE public.forum_poll_votes TO service_role;
GRANT SELECT ON SEQUENCE public.forum_poll_votes_id_seq TO anon;
GRANT UPDATE ON SEQUENCE public.forum_poll_votes_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.forum_poll_votes_id_seq TO anon;
GRANT SELECT ON SEQUENCE public.forum_poll_votes_id_seq TO authenticated;
GRANT UPDATE ON SEQUENCE public.forum_poll_votes_id_seq TO authenticated;
GRANT USAGE ON SEQUENCE public.forum_poll_votes_id_seq TO authenticated;
GRANT SELECT ON SEQUENCE public.forum_poll_votes_id_seq TO service_role;
GRANT UPDATE ON SEQUENCE public.forum_poll_votes_id_seq TO service_role;
GRANT USAGE ON SEQUENCE public.forum_poll_votes_id_seq TO service_role;
GRANT DELETE ON TABLE public.forum_posts TO anon;
GRANT INSERT ON TABLE public.forum_posts TO anon;
GRANT MAINTAIN ON TABLE public.forum_posts TO anon;
...
GRANT MAINTAIN ON TABLE public.forum_posts TO authenticated;
...
GRANT MAINTAIN ON TABLE public.forum_posts TO service_role;
...
GRANT SELECT ON SEQUENCE public.forum_posts_id_seq TO anon;
GRANT UPDATE ON SEQUENCE public.forum_posts_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.forum_posts_id_seq TO anon;
GRANT SELECT ON SEQUENCE public.forum_posts_id_seq TO authenticated;
GRANT UPDATE ON SEQUENCE public.forum_posts_id_seq TO authenticated;
GRANT USAGE ON SEQUENCE public.forum_posts_id_seq TO authenticated;
GRANT SELECT ON SEQUENCE public.forum_posts_id_seq TO service_role;
GRANT UPDATE ON SEQUENCE public.forum_posts_id_seq TO service_role;
GRANT USAGE ON SEQUENCE public.forum_posts_id_seq TO service_role;
...
GRANT SELECT ON SEQUENCE public.friendships_id_seq TO anon;
GRANT UPDATE ON SEQUENCE public.friendships_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.friendships_id_seq TO anon;
GRANT SELECT ON SEQUENCE public.friendships_id_seq TO authenticated;
GRANT UPDATE ON SEQUENCE public.friendships_id_seq TO authenticated;
GRANT USAGE ON SEQUENCE public.friendships_id_seq TO authenticated;
GRANT SELECT ON SEQUENCE public.friendships_id_seq TO service_role;
GRANT UPDATE ON SEQUENCE public.friendships_id_seq TO service_role;
...
GRANT MAINTAIN ON TABLE public.game_results TO anon;
...
GRANT MAINTAIN ON TABLE public.game_results TO authenticated;
...
GRANT MAINTAIN ON TABLE public.game_results TO service_role;
...
GRANT DELETE ON TABLE public.glossary TO anon;
GRANT INSERT ON TABLE public.glossary TO anon;
GRANT MAINTAIN ON TABLE public.glossary TO anon;
GRANT REFERENCES ON TABLE public.glossary TO anon;
GRANT SELECT ON TABLE public.glossary TO anon;
GRANT TRIGGER ON TABLE public.glossary TO anon;
GRANT TRUNCATE ON TABLE public.glossary TO anon;
GRANT UPDATE ON TABLE public.glossary TO anon;
GRANT DELETE ON TABLE public.glossary TO authenticated;
GRANT INSERT ON TABLE public.glossary TO authenticated;
GRANT MAINTAIN ON TABLE public.glossary TO authenticated;
GRANT REFERENCES ON TABLE public.glossary TO authenticated;
GRANT SELECT ON TABLE public.glossary TO authenticated;
GRANT TRIGGER ON TABLE public.glossary TO authenticated;
GRANT TRUNCATE ON TABLE public.glossary TO authenticated;
GRANT UPDATE ON TABLE public.glossary TO authenticated;
GRANT DELETE ON TABLE public.glossary TO service_role;
GRANT INSERT ON TABLE public.glossary TO service_role;
GRANT MAINTAIN ON TABLE public.glossary TO service_role;
GRANT REFERENCES ON TABLE public.glossary TO service_role;
GRANT SELECT ON TABLE public.glossary TO service_role;
GRANT TRIGGER ON TABLE public.glossary TO service_role;
GRANT TRUNCATE ON TABLE public.glossary TO service_role;
GRANT UPDATE ON TABLE public.glossary TO service_role;
GRANT DELETE ON TABLE public.guided_hands TO anon;
GRANT INSERT ON TABLE public.guided_hands TO anon;
GRANT MAINTAIN ON TABLE public.guided_hands TO anon;
GRANT REFERENCES ON TABLE public.guided_hands TO anon;
GRANT SELECT ON TABLE public.guided_hands TO anon;
GRANT TRIGGER ON TABLE public.guided_hands TO anon;
GRANT TRUNCATE ON TABLE public.guided_hands TO anon;
GRANT UPDATE ON TABLE public.guided_hands TO anon;
GRANT DELETE ON TABLE public.guided_hands TO authenticated;
GRANT INSERT ON TABLE public.guided_hands TO authenticated;
GRANT MAINTAIN ON TABLE public.guided_hands TO authenticated;
GRANT REFERENCES ON TABLE public.guided_hands TO authenticated;
GRANT SELECT ON TABLE public.guided_hands TO authenticated;
GRANT TRIGGER ON TABLE public.guided_hands TO authenticated;
GRANT TRUNCATE ON TABLE public.guided_hands TO authenticated;
GRANT UPDATE ON TABLE public.guided_hands TO authenticated;
GRANT DELETE ON TABLE public.guided_hands TO service_role;
GRANT INSERT ON TABLE public.guided_hands TO service_role;
GRANT MAINTAIN ON TABLE public.guided_hands TO service_role;
GRANT REFERENCES ON TABLE public.guided_hands TO service_role;
GRANT SELECT ON TABLE public.guided_hands TO service_role;
GRANT TRIGGER ON TABLE public.guided_hands TO service_role;
GRANT TRUNCATE ON TABLE public.guided_hands TO service_role;
GRANT UPDATE ON TABLE public.guided_hands TO service_role;
GRANT DELETE ON TABLE public.instructor_requests TO anon;
GRANT INSERT ON TABLE public.instructor_requests TO anon;
GRANT MAINTAIN ON TABLE public.instructor_requests TO anon;
GRANT REFERENCES ON TABLE public.instructor_requests TO anon;
GRANT SELECT ON TABLE public.instructor_requests TO anon;
GRANT TRIGGER ON TABLE public.instructor_requests TO anon;
GRANT TRUNCATE ON TABLE public.instructor_requests TO anon;
GRANT UPDATE ON TABLE public.instructor_requests TO anon;
GRANT DELETE ON TABLE public.instructor_requests TO authenticated;
GRANT INSERT ON TABLE public.instructor_requests TO authenticated;
GRANT MAINTAIN ON TABLE public.instructor_requests TO authenticated;
GRANT REFERENCES ON TABLE public.instructor_requests TO authenticated;
GRANT SELECT ON TABLE public.instructor_requests TO authenticated;
GRANT TRIGGER ON TABLE public.instructor_requests TO authenticated;
GRANT TRUNCATE ON TABLE public.instructor_requests TO authenticated;
GRANT UPDATE ON TABLE public.instructor_requests TO authenticated;
GRANT DELETE ON TABLE public.instructor_requests TO service_role;
GRANT INSERT ON TABLE public.instructor_requests TO service_role;
GRANT MAINTAIN ON TABLE public.instructor_requests TO service_role;
GRANT REFERENCES ON TABLE public.instructor_requests TO service_role;
GRANT SELECT ON TABLE public.instructor_requests TO service_role;
GRANT TRIGGER ON TABLE public.instructor_requests TO service_role;
GRANT TRUNCATE ON TABLE public.instructor_requests TO service_role;
GRANT UPDATE ON TABLE public.instructor_requests TO service_role;
GRANT DELETE ON TABLE public.inviti_aula TO anon;
GRANT INSERT ON TABLE public.inviti_aula TO anon;
GRANT MAINTAIN ON TABLE public.inviti_aula TO anon;
GRANT REFERENCES ON TABLE public.inviti_aula TO anon;
GRANT SELECT ON TABLE public.inviti_aula TO anon;
GRANT TRIGGER ON TABLE public.inviti_aula TO anon;
GRANT TRUNCATE ON TABLE public.inviti_aula TO anon;
GRANT UPDATE ON TABLE public.inviti_aula TO anon;
GRANT DELETE ON TABLE public.inviti_aula TO authenticated;
GRANT INSERT ON TABLE public.inviti_aula TO authenticated;
GRANT MAINTAIN ON TABLE public.inviti_aula TO authenticated;
GRANT REFERENCES ON TABLE public.inviti_aula TO authenticated;
GRANT SELECT ON TABLE public.inviti_aula TO authenticated;
GRANT TRIGGER ON TABLE public.inviti_aula TO authenticated;
GRANT TRUNCATE ON TABLE public.inviti_aula TO authenticated;
GRANT UPDATE ON TABLE public.inviti_aula TO authenticated;
GRANT DELETE ON TABLE public.inviti_aula TO service_role;
GRANT INSERT ON TABLE public.inviti_aula TO service_role;
GRANT MAINTAIN ON TABLE public.inviti_aula TO service_role;
GRANT REFERENCES ON TABLE public.inviti_aula TO service_role;
GRANT SELECT ON TABLE public.inviti_aula TO service_role;
GRANT TRIGGER ON TABLE public.inviti_aula TO service_role;
GRANT TRUNCATE ON TABLE public.inviti_aula TO service_role;
GRANT UPDATE ON TABLE public.inviti_aula TO service_role;
GRANT DELETE ON TABLE public.lesson_modules TO anon;
GRANT INSERT ON TABLE public.lesson_modules TO anon;
GRANT MAINTAIN ON TABLE public.lesson_modules TO anon;
GRANT REFERENCES ON TABLE public.lesson_modules TO anon;
GRANT SELECT ON TABLE public.lesson_modules TO anon;
GRANT TRIGGER ON TABLE public.lesson_modules TO anon;
GRANT TRUNCATE ON TABLE public.lesson_modules TO anon;
GRANT UPDATE ON TABLE public.lesson_modules TO anon;
GRANT DELETE ON TABLE public.lesson_modules TO authenticated;
GRANT INSERT ON TABLE public.lesson_modules TO authenticated;
GRANT MAINTAIN ON TABLE public.lesson_modules TO authenticated;
GRANT REFERENCES ON TABLE public.lesson_modules TO authenticated;
GRANT SELECT ON TABLE public.lesson_modules TO authenticated;
GRANT TRIGGER ON TABLE public.lesson_modules TO authenticated;
GRANT TRUNCATE ON TABLE public.lesson_modules TO authenticated;
GRANT UPDATE ON TABLE public.lesson_modules TO authenticated;
GRANT DELETE ON TABLE public.lesson_modules TO service_role;
GRANT INSERT ON TABLE public.lesson_modules TO service_role;
GRANT MAINTAIN ON TABLE public.lesson_modules TO service_role;
GRANT REFERENCES ON TABLE public.lesson_modules TO service_role;
GRANT SELECT ON TABLE public.lesson_modules TO service_role;
GRANT TRIGGER ON TABLE public.lesson_modules TO service_role;
GRANT TRUNCATE ON TABLE public.lesson_modules TO service_role;
GRANT UPDATE ON TABLE public.lesson_modules TO service_role;
...
GRANT DELETE ON TABLE public.libreria TO anon;
GRANT INSERT ON TABLE public.libreria TO anon;
GRANT MAINTAIN ON TABLE public.libreria TO anon;
GRANT REFERENCES ON TABLE public.libreria TO anon;
GRANT SELECT ON TABLE public.libreria TO anon;
GRANT TRIGGER ON TABLE public.libreria TO anon;
GRANT TRUNCATE ON TABLE public.libreria TO anon;
GRANT UPDATE ON TABLE public.libreria TO anon;
GRANT DELETE ON TABLE public.libreria TO authenticated;
GRANT INSERT ON TABLE public.libreria TO authenticated;
GRANT MAINTAIN ON TABLE public.libreria TO authenticated;
GRANT REFERENCES ON TABLE public.libreria TO authenticated;
GRANT SELECT ON TABLE public.libreria TO authenticated;
GRANT TRIGGER ON TABLE public.libreria TO authenticated;
GRANT TRUNCATE ON TABLE public.libreria TO authenticated;
GRANT UPDATE ON TABLE public.libreria TO authenticated;
GRANT DELETE ON TABLE public.libreria TO service_role;
GRANT INSERT ON TABLE public.libreria TO service_role;
GRANT MAINTAIN ON TABLE public.libreria TO service_role;
GRANT REFERENCES ON TABLE public.libreria TO service_role;
GRANT SELECT ON TABLE public.libreria TO service_role;
GRANT TRIGGER ON TABLE public.libreria TO service_role;
GRANT TRUNCATE ON TABLE public.libreria TO service_role;
GRANT UPDATE ON TABLE public.libreria TO service_role;
GRANT DELETE ON TABLE public.live_tables TO anon;
GRANT INSERT ON TABLE public.live_tables TO anon;
GRANT MAINTAIN ON TABLE public.live_tables TO anon;
GRANT REFERENCES ON TABLE public.live_tables TO anon;
GRANT SELECT ON TABLE public.live_tables TO anon;
GRANT TRIGGER ON TABLE public.live_tables TO anon;
GRANT TRUNCATE ON TABLE public.live_tables TO anon;
GRANT UPDATE ON TABLE public.live_tables TO anon;
GRANT DELETE ON TABLE public.live_tables TO authenticated;
GRANT INSERT ON TABLE public.live_tables TO authenticated;
GRANT MAINTAIN ON TABLE public.live_tables TO authenticated;
GRANT REFERENCES ON TABLE public.live_tables TO authenticated;
GRANT SELECT ON TABLE public.live_tables TO authenticated;
GRANT TRIGGER ON TABLE public.live_tables TO authenticated;
GRANT TRUNCATE ON TABLE public.live_tables TO authenticated;
GRANT UPDATE ON TABLE public.live_tables TO authenticated;
GRANT DELETE ON TABLE public.live_tables TO service_role;
GRANT INSERT ON TABLE public.live_tables TO service_role;
GRANT MAINTAIN ON TABLE public.live_tables TO service_role;
GRANT REFERENCES ON TABLE public.live_tables TO service_role;
GRANT SELECT ON TABLE public.live_tables TO service_role;
GRANT TRIGGER ON TABLE public.live_tables TO service_role;
GRANT TRUNCATE ON TABLE public.live_tables TO service_role;
GRANT UPDATE ON TABLE public.live_tables TO service_role;
GRANT DELETE ON TABLE public.login_history TO anon;
GRANT INSERT ON TABLE public.login_history TO anon;
GRANT MAINTAIN ON TABLE public.login_history TO anon;
...
GRANT MAINTAIN ON TABLE public.login_history TO authenticated;
...
GRANT MAINTAIN ON TABLE public.login_history TO service_role;
...
GRANT DELETE ON TABLE public.mani_generate TO anon;
GRANT INSERT ON TABLE public.mani_generate TO anon;
GRANT MAINTAIN ON TABLE public.mani_generate TO anon;
GRANT REFERENCES ON TABLE public.mani_generate TO anon;
GRANT SELECT ON TABLE public.mani_generate TO anon;
GRANT TRIGGER ON TABLE public.mani_generate TO anon;
GRANT TRUNCATE ON TABLE public.mani_generate TO anon;
GRANT UPDATE ON TABLE public.mani_generate TO anon;
GRANT DELETE ON TABLE public.mani_generate TO authenticated;
GRANT INSERT ON TABLE public.mani_generate TO authenticated;
GRANT MAINTAIN ON TABLE public.mani_generate TO authenticated;
GRANT REFERENCES ON TABLE public.mani_generate TO authenticated;
GRANT SELECT ON TABLE public.mani_generate TO authenticated;
GRANT TRIGGER ON TABLE public.mani_generate TO authenticated;
GRANT TRUNCATE ON TABLE public.mani_generate TO authenticated;
GRANT UPDATE ON TABLE public.mani_generate TO authenticated;
GRANT DELETE ON TABLE public.mani_generate TO service_role;
GRANT INSERT ON TABLE public.mani_generate TO service_role;
GRANT MAINTAIN ON TABLE public.mani_generate TO service_role;
GRANT REFERENCES ON TABLE public.mani_generate TO service_role;
GRANT SELECT ON TABLE public.mani_generate TO service_role;
GRANT TRIGGER ON TABLE public.mani_generate TO service_role;
GRANT TRUNCATE ON TABLE public.mani_generate TO service_role;
GRANT UPDATE ON TABLE public.mani_generate TO service_role;
GRANT DELETE ON TABLE public.modelli_mani TO anon;
GRANT INSERT ON TABLE public.modelli_mani TO anon;
GRANT MAINTAIN ON TABLE public.modelli_mani TO anon;
GRANT REFERENCES ON TABLE public.modelli_mani TO anon;
GRANT SELECT ON TABLE public.modelli_mani TO anon;
GRANT TRIGGER ON TABLE public.modelli_mani TO anon;
GRANT TRUNCATE ON TABLE public.modelli_mani TO anon;
GRANT UPDATE ON TABLE public.modelli_mani TO anon;
GRANT DELETE ON TABLE public.modelli_mani TO authenticated;
GRANT INSERT ON TABLE public.modelli_mani TO authenticated;
GRANT MAINTAIN ON TABLE public.modelli_mani TO authenticated;
GRANT REFERENCES ON TABLE public.modelli_mani TO authenticated;
GRANT SELECT ON TABLE public.modelli_mani TO authenticated;
GRANT TRIGGER ON TABLE public.modelli_mani TO authenticated;
GRANT TRUNCATE ON TABLE public.modelli_mani TO authenticated;
GRANT UPDATE ON TABLE public.modelli_mani TO authenticated;
GRANT DELETE ON TABLE public.modelli_mani TO service_role;
GRANT INSERT ON TABLE public.modelli_mani TO service_role;
GRANT MAINTAIN ON TABLE public.modelli_mani TO service_role;
GRANT REFERENCES ON TABLE public.modelli_mani TO service_role;
GRANT SELECT ON TABLE public.modelli_mani TO service_role;
GRANT TRIGGER ON TABLE public.modelli_mani TO service_role;
GRANT TRUNCATE ON TABLE public.modelli_mani TO service_role;
GRANT UPDATE ON TABLE public.modelli_mani TO service_role;
GRANT DELETE ON TABLE public.note_smazzate TO anon;
GRANT INSERT ON TABLE public.note_smazzate TO anon;
GRANT MAINTAIN ON TABLE public.note_smazzate TO anon;
GRANT REFERENCES ON TABLE public.note_smazzate TO anon;
GRANT SELECT ON TABLE public.note_smazzate TO anon;
GRANT TRIGGER ON TABLE public.note_smazzate TO anon;
GRANT TRUNCATE ON TABLE public.note_smazzate TO anon;
GRANT UPDATE ON TABLE public.note_smazzate TO anon;
GRANT DELETE ON TABLE public.note_smazzate TO authenticated;
GRANT INSERT ON TABLE public.note_smazzate TO authenticated;
GRANT MAINTAIN ON TABLE public.note_smazzate TO authenticated;
GRANT REFERENCES ON TABLE public.note_smazzate TO authenticated;
GRANT SELECT ON TABLE public.note_smazzate TO authenticated;
GRANT TRIGGER ON TABLE public.note_smazzate TO authenticated;
GRANT TRUNCATE ON TABLE public.note_smazzate TO authenticated;
GRANT UPDATE ON TABLE public.note_smazzate TO authenticated;
GRANT DELETE ON TABLE public.note_smazzate TO service_role;
GRANT INSERT ON TABLE public.note_smazzate TO service_role;
GRANT MAINTAIN ON TABLE public.note_smazzate TO service_role;
GRANT REFERENCES ON TABLE public.note_smazzate TO service_role;
GRANT SELECT ON TABLE public.note_smazzate TO service_role;
GRANT TRIGGER ON TABLE public.note_smazzate TO service_role;
GRANT TRUNCATE ON TABLE public.note_smazzate TO service_role;
GRANT UPDATE ON TABLE public.note_smazzate TO service_role;
GRANT DELETE ON TABLE public.partner_profiles TO anon;
GRANT INSERT ON TABLE public.partner_profiles TO anon;
GRANT MAINTAIN ON TABLE public.partner_profiles TO anon;
GRANT REFERENCES ON TABLE public.partner_profiles TO anon;
GRANT SELECT ON TABLE public.partner_profiles TO anon;
GRANT TRIGGER ON TABLE public.partner_profiles TO anon;
GRANT TRUNCATE ON TABLE public.partner_profiles TO anon;
GRANT UPDATE ON TABLE public.partner_profiles TO anon;
GRANT DELETE ON TABLE public.partner_profiles TO authenticated;
GRANT INSERT ON TABLE public.partner_profiles TO authenticated;
GRANT MAINTAIN ON TABLE public.partner_profiles TO authenticated;
GRANT REFERENCES ON TABLE public.partner_profiles TO authenticated;
GRANT SELECT ON TABLE public.partner_profiles TO authenticated;
GRANT TRIGGER ON TABLE public.partner_profiles TO authenticated;
GRANT TRUNCATE ON TABLE public.partner_profiles TO authenticated;
GRANT UPDATE ON TABLE public.partner_profiles TO authenticated;
GRANT DELETE ON TABLE public.partner_profiles TO service_role;
GRANT INSERT ON TABLE public.partner_profiles TO service_role;
GRANT MAINTAIN ON TABLE public.partner_profiles TO service_role;
GRANT REFERENCES ON TABLE public.partner_profiles TO service_role;
GRANT SELECT ON TABLE public.partner_profiles TO service_role;
GRANT TRIGGER ON TABLE public.partner_profiles TO service_role;
GRANT TRUNCATE ON TABLE public.partner_profiles TO service_role;
GRANT UPDATE ON TABLE public.partner_profiles TO service_role;
GRANT DELETE ON TABLE public.posizioni_preferite TO anon;
GRANT INSERT ON TABLE public.posizioni_preferite TO anon;
GRANT MAINTAIN ON TABLE public.posizioni_preferite TO anon;
GRANT REFERENCES ON TABLE public.posizioni_preferite TO anon;
GRANT SELECT ON TABLE public.posizioni_preferite TO anon;
GRANT TRIGGER ON TABLE public.posizioni_preferite TO anon;
GRANT TRUNCATE ON TABLE public.posizioni_preferite TO anon;
GRANT UPDATE ON TABLE public.posizioni_preferite TO anon;
GRANT DELETE ON TABLE public.posizioni_preferite TO authenticated;
GRANT INSERT ON TABLE public.posizioni_preferite TO authenticated;
GRANT MAINTAIN ON TABLE public.posizioni_preferite TO authenticated;
GRANT REFERENCES ON TABLE public.posizioni_preferite TO authenticated;
GRANT SELECT ON TABLE public.posizioni_preferite TO authenticated;
GRANT TRIGGER ON TABLE public.posizioni_preferite TO authenticated;
GRANT TRUNCATE ON TABLE public.posizioni_preferite TO authenticated;
GRANT UPDATE ON TABLE public.posizioni_preferite TO authenticated;
GRANT DELETE ON TABLE public.posizioni_preferite TO service_role;
GRANT INSERT ON TABLE public.posizioni_preferite TO service_role;
GRANT MAINTAIN ON TABLE public.posizioni_preferite TO service_role;
GRANT REFERENCES ON TABLE public.posizioni_preferite TO service_role;
GRANT SELECT ON TABLE public.posizioni_preferite TO service_role;
GRANT TRIGGER ON TABLE public.posizioni_preferite TO service_role;
GRANT TRUNCATE ON TABLE public.posizioni_preferite TO service_role;
GRANT UPDATE ON TABLE public.posizioni_preferite TO service_role;
GRANT DELETE ON TABLE public.presenze TO anon;
GRANT INSERT ON TABLE public.presenze TO anon;
GRANT MAINTAIN ON TABLE public.presenze TO anon;
GRANT REFERENCES ON TABLE public.presenze TO anon;
GRANT SELECT ON TABLE public.presenze TO anon;
GRANT TRIGGER ON TABLE public.presenze TO anon;
GRANT TRUNCATE ON TABLE public.presenze TO anon;
GRANT UPDATE ON TABLE public.presenze TO anon;
GRANT DELETE ON TABLE public.presenze TO authenticated;
GRANT INSERT ON TABLE public.presenze TO authenticated;
GRANT MAINTAIN ON TABLE public.presenze TO authenticated;
GRANT REFERENCES ON TABLE public.presenze TO authenticated;
GRANT SELECT ON TABLE public.presenze TO authenticated;
GRANT TRIGGER ON TABLE public.presenze TO authenticated;
GRANT TRUNCATE ON TABLE public.presenze TO authenticated;
GRANT UPDATE ON TABLE public.presenze TO authenticated;
GRANT DELETE ON TABLE public.presenze TO service_role;
GRANT INSERT ON TABLE public.presenze TO service_role;
GRANT MAINTAIN ON TABLE public.presenze TO service_role;
GRANT REFERENCES ON TABLE public.presenze TO service_role;
GRANT SELECT ON TABLE public.presenze TO service_role;
GRANT TRIGGER ON TABLE public.presenze TO service_role;
GRANT TRUNCATE ON TABLE public.presenze TO service_role;
GRANT UPDATE ON TABLE public.presenze TO service_role;
...
GRANT DELETE ON TABLE public.review_items TO anon;
GRANT INSERT ON TABLE public.review_items TO anon;
GRANT MAINTAIN ON TABLE public.review_items TO anon;
GRANT REFERENCES ON TABLE public.review_items TO anon;
GRANT SELECT ON TABLE public.review_items TO anon;
GRANT TRIGGER ON TABLE public.review_items TO anon;
GRANT TRUNCATE ON TABLE public.review_items TO anon;
GRANT UPDATE ON TABLE public.review_items TO anon;
GRANT DELETE ON TABLE public.review_items TO authenticated;
GRANT INSERT ON TABLE public.review_items TO authenticated;
GRANT MAINTAIN ON TABLE public.review_items TO authenticated;
GRANT REFERENCES ON TABLE public.review_items TO authenticated;
GRANT SELECT ON TABLE public.review_items TO authenticated;
GRANT TRIGGER ON TABLE public.review_items TO authenticated;
GRANT TRUNCATE ON TABLE public.review_items TO authenticated;
GRANT UPDATE ON TABLE public.review_items TO authenticated;
GRANT DELETE ON TABLE public.review_items TO service_role;
GRANT INSERT ON TABLE public.review_items TO service_role;
GRANT MAINTAIN ON TABLE public.review_items TO service_role;
GRANT REFERENCES ON TABLE public.review_items TO service_role;
GRANT SELECT ON TABLE public.review_items TO service_role;
GRANT TRIGGER ON TABLE public.review_items TO service_role;
GRANT TRUNCATE ON TABLE public.review_items TO service_role;
GRANT UPDATE ON TABLE public.review_items TO service_role;
GRANT SELECT ON SEQUENCE public.review_items_id_seq TO anon;
GRANT UPDATE ON SEQUENCE public.review_items_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.review_items_id_seq TO anon;
GRANT SELECT ON SEQUENCE public.review_items_id_seq TO authenticated;
GRANT UPDATE ON SEQUENCE public.review_items_id_seq TO authenticated;
GRANT USAGE ON SEQUENCE public.review_items_id_seq TO authenticated;
GRANT SELECT ON SEQUENCE public.review_items_id_seq TO service_role;
GRANT UPDATE ON SEQUENCE public.review_items_id_seq TO service_role;
GRANT USAGE ON SEQUENCE public.review_items_id_seq TO service_role;
GRANT DELETE ON TABLE public.risposte_sondaggio TO anon;
GRANT INSERT ON TABLE public.risposte_sondaggio TO anon;
GRANT MAINTAIN ON TABLE public.risposte_sondaggio TO anon;
GRANT REFERENCES ON TABLE public.risposte_sondaggio TO anon;
GRANT SELECT ON TABLE public.risposte_sondaggio TO anon;
GRANT TRIGGER ON TABLE public.risposte_sondaggio TO anon;
GRANT TRUNCATE ON TABLE public.risposte_sondaggio TO anon;
GRANT UPDATE ON TABLE public.risposte_sondaggio TO anon;
GRANT DELETE ON TABLE public.risposte_sondaggio TO authenticated;
GRANT INSERT ON TABLE public.risposte_sondaggio TO authenticated;
GRANT MAINTAIN ON TABLE public.risposte_sondaggio TO authenticated;
GRANT REFERENCES ON TABLE public.risposte_sondaggio TO authenticated;
GRANT SELECT ON TABLE public.risposte_sondaggio TO authenticated;
GRANT TRIGGER ON TABLE public.risposte_sondaggio TO authenticated;
GRANT TRUNCATE ON TABLE public.risposte_sondaggio TO authenticated;
GRANT UPDATE ON TABLE public.risposte_sondaggio TO authenticated;
GRANT DELETE ON TABLE public.risposte_sondaggio TO service_role;
GRANT INSERT ON TABLE public.risposte_sondaggio TO service_role;
GRANT MAINTAIN ON TABLE public.risposte_sondaggio TO service_role;
GRANT REFERENCES ON TABLE public.risposte_sondaggio TO service_role;
GRANT SELECT ON TABLE public.risposte_sondaggio TO service_role;
GRANT TRIGGER ON TABLE public.risposte_sondaggio TO service_role;
GRANT TRUNCATE ON TABLE public.risposte_sondaggio TO service_role;
GRANT UPDATE ON TABLE public.risposte_sondaggio TO service_role;
GRANT DELETE ON TABLE public.risultati_mano TO anon;
GRANT INSERT ON TABLE public.risultati_mano TO anon;
GRANT MAINTAIN ON TABLE public.risultati_mano TO anon;
GRANT REFERENCES ON TABLE public.risultati_mano TO anon;
GRANT SELECT ON TABLE public.risultati_mano TO anon;
GRANT TRIGGER ON TABLE public.risultati_mano TO anon;
GRANT TRUNCATE ON TABLE public.risultati_mano TO anon;
GRANT UPDATE ON TABLE public.risultati_mano TO anon;
GRANT DELETE ON TABLE public.risultati_mano TO authenticated;
GRANT INSERT ON TABLE public.risultati_mano TO authenticated;
GRANT MAINTAIN ON TABLE public.risultati_mano TO authenticated;
GRANT REFERENCES ON TABLE public.risultati_mano TO authenticated;
GRANT SELECT ON TABLE public.risultati_mano TO authenticated;
GRANT TRIGGER ON TABLE public.risultati_mano TO authenticated;
GRANT TRUNCATE ON TABLE public.risultati_mano TO authenticated;
GRANT UPDATE ON TABLE public.risultati_mano TO authenticated;
GRANT DELETE ON TABLE public.risultati_mano TO service_role;
GRANT INSERT ON TABLE public.risultati_mano TO service_role;
GRANT MAINTAIN ON TABLE public.risultati_mano TO service_role;
GRANT REFERENCES ON TABLE public.risultati_mano TO service_role;
GRANT SELECT ON TABLE public.risultati_mano TO service_role;
GRANT TRIGGER ON TABLE public.risultati_mano TO service_role;
GRANT TRUNCATE ON TABLE public.risultati_mano TO service_role;
GRANT UPDATE ON TABLE public.risultati_mano TO service_role;
GRANT INSERT ON TABLE public.risultati_torneo TO authenticated;
GRANT SELECT ON TABLE public.risultati_torneo TO authenticated;
GRANT DELETE ON TABLE public.risultati_torneo TO service_role;
GRANT INSERT ON TABLE public.risultati_torneo TO service_role;
GRANT MAINTAIN ON TABLE public.risultati_torneo TO service_role;
GRANT REFERENCES ON TABLE public.risultati_torneo TO service_role;
GRANT SELECT ON TABLE public.risultati_torneo TO service_role;
GRANT TRIGGER ON TABLE public.risultati_torneo TO service_role;
GRANT TRUNCATE ON TABLE public.risultati_torneo TO service_role;
GRANT UPDATE ON TABLE public.risultati_torneo TO service_role;
GRANT DELETE ON TABLE public.saved_hands TO anon;
GRANT INSERT ON TABLE public.saved_hands TO anon;
GRANT MAINTAIN ON TABLE public.saved_hands TO anon;
GRANT REFERENCES ON TABLE public.saved_hands TO anon;
GRANT SELECT ON TABLE public.saved_hands TO anon;
GRANT TRIGGER ON TABLE public.saved_hands TO anon;
GRANT TRUNCATE ON TABLE public.saved_hands TO anon;
GRANT UPDATE ON TABLE public.saved_hands TO anon;
GRANT DELETE ON TABLE public.saved_hands TO authenticated;
GRANT INSERT ON TABLE public.saved_hands TO authenticated;
GRANT MAINTAIN ON TABLE public.saved_hands TO authenticated;
GRANT REFERENCES ON TABLE public.saved_hands TO authenticated;
GRANT SELECT ON TABLE public.saved_hands TO authenticated;
GRANT TRIGGER ON TABLE public.saved_hands TO authenticated;
GRANT TRUNCATE ON TABLE public.saved_hands TO authenticated;
GRANT UPDATE ON TABLE public.saved_hands TO authenticated;
GRANT DELETE ON TABLE public.saved_hands TO service_role;
GRANT INSERT ON TABLE public.saved_hands TO service_role;
GRANT MAINTAIN ON TABLE public.saved_hands TO service_role;
GRANT REFERENCES ON TABLE public.saved_hands TO service_role;
GRANT SELECT ON TABLE public.saved_hands TO service_role;
GRANT TRIGGER ON TABLE public.saved_hands TO service_role;
GRANT TRUNCATE ON TABLE public.saved_hands TO service_role;
GRANT UPDATE ON TABLE public.saved_hands TO service_role;
GRANT DELETE ON TABLE public.scenari TO anon;
GRANT INSERT ON TABLE public.scenari TO anon;
GRANT MAINTAIN ON TABLE public.scenari TO anon;
GRANT REFERENCES ON TABLE public.scenari TO anon;
GRANT SELECT ON TABLE public.scenari TO anon;
GRANT TRIGGER ON TABLE public.scenari TO anon;
GRANT TRUNCATE ON TABLE public.scenari TO anon;
GRANT UPDATE ON TABLE public.scenari TO anon;
GRANT DELETE ON TABLE public.scenari TO authenticated;
GRANT INSERT ON TABLE public.scenari TO authenticated;
GRANT MAINTAIN ON TABLE public.scenari TO authenticated;
GRANT REFERENCES ON TABLE public.scenari TO authenticated;
GRANT SELECT ON TABLE public.scenari TO authenticated;
GRANT TRIGGER ON TABLE public.scenari TO authenticated;
GRANT TRUNCATE ON TABLE public.scenari TO authenticated;
GRANT UPDATE ON TABLE public.scenari TO authenticated;
GRANT DELETE ON TABLE public.scenari TO service_role;
GRANT INSERT ON TABLE public.scenari TO service_role;
GRANT MAINTAIN ON TABLE public.scenari TO service_role;
GRANT REFERENCES ON TABLE public.scenari TO service_role;
GRANT SELECT ON TABLE public.scenari TO service_role;
...
GRANT REFERENCES ON TABLE public.segnalazioni TO anon;
GRANT SELECT ON TABLE public.segnalazioni TO anon;
GRANT TRIGGER ON TABLE public.segnalazioni TO anon;
GRANT TRUNCATE ON TABLE public.segnalazioni TO anon;
GRANT UPDATE ON TABLE public.segnalazioni TO anon;
GRANT DELETE ON TABLE public.segnalazioni TO authenticated;
GRANT INSERT ON TABLE public.segnalazioni TO authenticated;
GRANT MAINTAIN ON TABLE public.segnalazioni TO authenticated;
GRANT REFERENCES ON TABLE public.segnalazioni TO authenticated;
GRANT SELECT ON TABLE public.segnalazioni TO authenticated;
GRANT TRIGGER ON TABLE public.segnalazioni TO authenticated;
GRANT TRUNCATE ON TABLE public.segnalazioni TO authenticated;
GRANT UPDATE ON TABLE public.segnalazioni TO authenticated;
GRANT DELETE ON TABLE public.segnalazioni TO service_role;
GRANT INSERT ON TABLE public.segnalazioni TO service_role;
GRANT MAINTAIN ON TABLE public.segnalazioni TO service_role;
GRANT REFERENCES ON TABLE public.segnalazioni TO service_role;
GRANT SELECT ON TABLE public.segnalazioni TO service_role;
GRANT TRIGGER ON TABLE public.segnalazioni TO service_role;
GRANT TRUNCATE ON TABLE public.segnalazioni TO service_role;
GRANT UPDATE ON TABLE public.segnalazioni TO service_role;
GRANT DELETE ON TABLE public.sessioni_aula TO anon;
GRANT INSERT ON TABLE public.sessioni_aula TO anon;
GRANT MAINTAIN ON TABLE public.sessioni_aula TO anon;
GRANT REFERENCES ON TABLE public.sessioni_aula TO anon;
GRANT SELECT ON TABLE public.sessioni_aula TO anon;
GRANT TRIGGER ON TABLE public.sessioni_aula TO anon;
GRANT TRUNCATE ON TABLE public.sessioni_aula TO anon;
GRANT UPDATE ON TABLE public.sessioni_aula TO anon;
GRANT DELETE ON TABLE public.sessioni_aula TO authenticated;
GRANT INSERT ON TABLE public.sessioni_aula TO authenticated;
GRANT MAINTAIN ON TABLE public.sessioni_aula TO authenticated;
GRANT REFERENCES ON TABLE public.sessioni_aula TO authenticated;
GRANT SELECT ON TABLE public.sessioni_aula TO authenticated;
GRANT TRIGGER ON TABLE public.sessioni_aula TO authenticated;
GRANT TRUNCATE ON TABLE public.sessioni_aula TO authenticated;
GRANT UPDATE ON TABLE public.sessioni_aula TO authenticated;
GRANT DELETE ON TABLE public.sessioni_aula TO service_role;
GRANT INSERT ON TABLE public.sessioni_aula TO service_role;
GRANT MAINTAIN ON TABLE public.sessioni_aula TO service_role;
GRANT REFERENCES ON TABLE public.sessioni_aula TO service_role;
GRANT SELECT ON TABLE public.sessioni_aula TO service_role;
GRANT TRIGGER ON TABLE public.sessioni_aula TO service_role;
GRANT TRUNCATE ON TABLE public.sessioni_aula TO service_role;
GRANT UPDATE ON TABLE public.sessioni_aula TO service_role;
GRANT DELETE ON TABLE public.sfida_board TO anon;
GRANT INSERT ON TABLE public.sfida_board TO anon;
GRANT MAINTAIN ON TABLE public.sfida_board TO anon;
GRANT REFERENCES ON TABLE public.sfida_board TO anon;
GRANT SELECT ON TABLE public.sfida_board TO anon;
GRANT TRIGGER ON TABLE public.sfida_board TO anon;
GRANT TRUNCATE ON TABLE public.sfida_board TO anon;
GRANT UPDATE ON TABLE public.sfida_board TO anon;
GRANT DELETE ON TABLE public.sfida_board TO authenticated;
GRANT INSERT ON TABLE public.sfida_board TO authenticated;
GRANT MAINTAIN ON TABLE public.sfida_board TO authenticated;
GRANT REFERENCES ON TABLE public.sfida_board TO authenticated;
GRANT SELECT ON TABLE public.sfida_board TO authenticated;
GRANT TRIGGER ON TABLE public.sfida_board TO authenticated;
GRANT TRUNCATE ON TABLE public.sfida_board TO authenticated;
GRANT UPDATE ON TABLE public.sfida_board TO authenticated;
GRANT DELETE ON TABLE public.sfida_board TO service_role;
GRANT INSERT ON TABLE public.sfida_board TO service_role;
GRANT MAINTAIN ON TABLE public.sfida_board TO service_role;
GRANT REFERENCES ON TABLE public.sfida_board TO service_role;
GRANT SELECT ON TABLE public.sfida_board TO service_role;
GRANT TRIGGER ON TABLE public.sfida_board TO service_role;
GRANT TRUNCATE ON TABLE public.sfida_board TO service_role;
GRANT UPDATE ON TABLE public.sfida_board TO service_role;
GRANT DELETE ON TABLE public.sfide_coppie TO anon;
GRANT INSERT ON TABLE public.sfide_coppie TO anon;
GRANT MAINTAIN ON TABLE public.sfide_coppie TO anon;
GRANT REFERENCES ON TABLE public.sfide_coppie TO anon;
GRANT SELECT ON TABLE public.sfide_coppie TO anon;
GRANT TRIGGER ON TABLE public.sfide_coppie TO anon;
GRANT TRUNCATE ON TABLE public.sfide_coppie TO anon;
GRANT UPDATE ON TABLE public.sfide_coppie TO anon;
GRANT DELETE ON TABLE public.sfide_coppie TO authenticated;
GRANT INSERT ON TABLE public.sfide_coppie TO authenticated;
GRANT MAINTAIN ON TABLE public.sfide_coppie TO authenticated;
GRANT REFERENCES ON TABLE public.sfide_coppie TO authenticated;
GRANT SELECT ON TABLE public.sfide_coppie TO authenticated;
GRANT TRIGGER ON TABLE public.sfide_coppie TO authenticated;
GRANT TRUNCATE ON TABLE public.sfide_coppie TO authenticated;
GRANT UPDATE ON TABLE public.sfide_coppie TO authenticated;
GRANT DELETE ON TABLE public.sfide_coppie TO service_role;
GRANT INSERT ON TABLE public.sfide_coppie TO service_role;
GRANT MAINTAIN ON TABLE public.sfide_coppie TO service_role;
GRANT REFERENCES ON TABLE public.sfide_coppie TO service_role;
GRANT SELECT ON TABLE public.sfide_coppie TO service_role;
GRANT TRIGGER ON TABLE public.sfide_coppie TO service_role;
GRANT TRUNCATE ON TABLE public.sfide_coppie TO service_role;
GRANT UPDATE ON TABLE public.sfide_coppie TO service_role;
GRANT DELETE ON TABLE public.smazzate TO anon;
GRANT INSERT ON TABLE public.smazzate TO anon;
GRANT MAINTAIN ON TABLE public.smazzate TO anon;
GRANT REFERENCES ON TABLE public.smazzate TO anon;
GRANT TRIGGER ON TABLE public.smazzate TO anon;
GRANT TRUNCATE ON TABLE public.smazzate TO anon;
GRANT UPDATE ON TABLE public.smazzate TO anon;
GRANT DELETE ON TABLE public.smazzate TO authenticated;
GRANT INSERT ON TABLE public.smazzate TO authenticated;
GRANT MAINTAIN ON TABLE public.smazzate TO authenticated;
GRANT REFERENCES ON TABLE public.smazzate TO authenticated;
GRANT TRIGGER ON TABLE public.smazzate TO authenticated;
GRANT TRUNCATE ON TABLE public.smazzate TO authenticated;
GRANT UPDATE ON TABLE public.smazzate TO authenticated;
GRANT DELETE ON TABLE public.smazzate TO service_role;
GRANT INSERT ON TABLE public.smazzate TO service_role;
GRANT MAINTAIN ON TABLE public.smazzate TO service_role;
GRANT REFERENCES ON TABLE public.smazzate TO service_role;
GRANT SELECT ON TABLE public.smazzate TO service_role;
GRANT TRIGGER ON TABLE public.smazzate TO service_role;
GRANT TRUNCATE ON TABLE public.smazzate TO service_role;
GRANT UPDATE ON TABLE public.smazzate TO service_role;
GRANT DELETE ON TABLE public.sondaggi TO anon;
GRANT INSERT ON TABLE public.sondaggi TO anon;
GRANT MAINTAIN ON TABLE public.sondaggi TO anon;
GRANT REFERENCES ON TABLE public.sondaggi TO anon;
GRANT SELECT ON TABLE public.sondaggi TO anon;
GRANT TRIGGER ON TABLE public.sondaggi TO anon;
GRANT TRUNCATE ON TABLE public.sondaggi TO anon;
GRANT UPDATE ON TABLE public.sondaggi TO anon;
GRANT DELETE ON TABLE public.sondaggi TO authenticated;
GRANT INSERT ON TABLE public.sondaggi TO authenticated;
GRANT MAINTAIN ON TABLE public.sondaggi TO authenticated;
GRANT REFERENCES ON TABLE public.sondaggi TO authenticated;
GRANT SELECT ON TABLE public.sondaggi TO authenticated;
GRANT TRIGGER ON TABLE public.sondaggi TO authenticated;
GRANT TRUNCATE ON TABLE public.sondaggi TO authenticated;
GRANT UPDATE ON TABLE public.sondaggi TO authenticated;
GRANT DELETE ON TABLE public.sondaggi TO service_role;
GRANT INSERT ON TABLE public.sondaggi TO service_role;
GRANT MAINTAIN ON TABLE public.sondaggi TO service_role;
GRANT REFERENCES ON TABLE public.sondaggi TO service_role;
GRANT SELECT ON TABLE public.sondaggi TO service_role;
GRANT TRIGGER ON TABLE public.sondaggi TO service_role;
GRANT TRUNCATE ON TABLE public.sondaggi TO service_role;
GRANT UPDATE ON TABLE public.sondaggi TO service_role;
GRANT DELETE ON TABLE public.tornei TO anon;
GRANT INSERT ON TABLE public.tornei TO anon;
GRANT MAINTAIN ON TABLE public.tornei TO anon;
GRANT REFERENCES ON TABLE public.tornei TO anon;
GRANT SELECT ON TABLE public.tornei TO anon;
GRANT TRIGGER ON TABLE public.tornei TO anon;
GRANT TRUNCATE ON TABLE public.tornei TO anon;
GRANT UPDATE ON TABLE public.tornei TO anon;
GRANT DELETE ON TABLE public.tornei TO authenticated;
GRANT INSERT ON TABLE public.tornei TO authenticated;
GRANT MAINTAIN ON TABLE public.tornei TO authenticated;
GRANT REFERENCES ON TABLE public.tornei TO authenticated;
GRANT SELECT ON TABLE public.tornei TO authenticated;
GRANT TRIGGER ON TABLE public.tornei TO authenticated;
GRANT TRUNCATE ON TABLE public.tornei TO authenticated;
GRANT UPDATE ON TABLE public.tornei TO authenticated;
GRANT DELETE ON TABLE public.tornei TO service_role;
GRANT INSERT ON TABLE public.tornei TO service_role;
GRANT MAINTAIN ON TABLE public.tornei TO service_role;
GRANT REFERENCES ON TABLE public.tornei TO service_role;
GRANT SELECT ON TABLE public.tornei TO service_role;
GRANT TRIGGER ON TABLE public.tornei TO service_role;
GRANT TRUNCATE ON TABLE public.tornei TO service_role;
GRANT UPDATE ON TABLE public.tornei TO service_role;
GRANT DELETE ON TABLE public.torneo_mani TO anon;
GRANT INSERT ON TABLE public.torneo_mani TO anon;
GRANT MAINTAIN ON TABLE public.torneo_mani TO anon;
GRANT REFERENCES ON TABLE public.torneo_mani TO anon;
GRANT SELECT ON TABLE public.torneo_mani TO anon;
GRANT TRIGGER ON TABLE public.torneo_mani TO anon;
GRANT TRUNCATE ON TABLE public.torneo_mani TO anon;
GRANT UPDATE ON TABLE public.torneo_mani TO anon;
GRANT DELETE ON TABLE public.torneo_mani TO authenticated;
GRANT INSERT ON TABLE public.torneo_mani TO authenticated;
GRANT MAINTAIN ON TABLE public.torneo_mani TO authenticated;
GRANT REFERENCES ON TABLE public.torneo_mani TO authenticated;
GRANT SELECT ON TABLE public.torneo_mani TO authenticated;
GRANT TRIGGER ON TABLE public.torneo_mani TO authenticated;
GRANT TRUNCATE ON TABLE public.torneo_mani TO authenticated;
GRANT UPDATE ON TABLE public.torneo_mani TO authenticated;
GRANT DELETE ON TABLE public.torneo_mani TO service_role;
GRANT INSERT ON TABLE public.torneo_mani TO service_role;
GRANT MAINTAIN ON TABLE public.torneo_mani TO service_role;
GRANT REFERENCES ON TABLE public.torneo_mani TO service_role;
GRANT SELECT ON TABLE public.torneo_mani TO service_role;
GRANT TRIGGER ON TABLE public.torneo_mani TO service_role;
GRANT TRUNCATE ON TABLE public.torneo_mani TO service_role;
GRANT UPDATE ON TABLE public.torneo_mani TO service_role;
GRANT DELETE ON TABLE public.tournament_results TO anon;
GRANT INSERT ON TABLE public.tournament_results TO anon;
GRANT MAINTAIN ON TABLE public.tournament_results TO anon;
GRANT REFERENCES ON TABLE public.tournament_results TO anon;
GRANT SELECT ON TABLE public.tournament_results TO anon;
GRANT TRIGGER ON TABLE public.tournament_results TO anon;
GRANT TRUNCATE ON TABLE public.tournament_results TO anon;
...
GRANT MAINTAIN ON TABLE public.tournament_results TO authenticated;
GRANT REFERENCES ON TABLE public.tournament_results TO authenticated;
GRANT SELECT ON TABLE public.tournament_results TO authenticated;
GRANT TRIGGER ON TABLE public.tournament_results TO authenticated;
GRANT TRUNCATE ON TABLE public.tournament_results TO authenticated;
...
GRANT MAINTAIN ON TABLE public.tournament_results TO service_role;
GRANT REFERENCES ON TABLE public.tournament_results TO service_role;
GRANT SELECT ON TABLE public.tournament_results TO service_role;
GRANT TRIGGER ON TABLE public.tournament_results TO service_role;
GRANT TRUNCATE ON TABLE public.tournament_results TO service_role;
GRANT UPDATE ON TABLE public.tournament_results TO service_role;
GRANT DELETE ON TABLE public.traduzioni_stato TO anon;
GRANT INSERT ON TABLE public.traduzioni_stato TO anon;
GRANT MAINTAIN ON TABLE public.traduzioni_stato TO anon;
GRANT REFERENCES ON TABLE public.traduzioni_stato TO anon;
GRANT SELECT ON TABLE public.traduzioni_stato TO anon;
GRANT TRIGGER ON TABLE public.traduzioni_stato TO anon;
GRANT TRUNCATE ON TABLE public.traduzioni_stato TO anon;
GRANT UPDATE ON TABLE public.traduzioni_stato TO anon;
GRANT DELETE ON TABLE public.traduzioni_stato TO authenticated;
GRANT INSERT ON TABLE public.traduzioni_stato TO authenticated;
GRANT MAINTAIN ON TABLE public.traduzioni_stato TO authenticated;
GRANT REFERENCES ON TABLE public.traduzioni_stato TO authenticated;
GRANT SELECT ON TABLE public.traduzioni_stato TO authenticated;
GRANT TRIGGER ON TABLE public.traduzioni_stato TO authenticated;
GRANT TRUNCATE ON TABLE public.traduzioni_stato TO authenticated;
GRANT UPDATE ON TABLE public.traduzioni_stato TO authenticated;
GRANT DELETE ON TABLE public.traduzioni_stato TO service_role;
GRANT INSERT ON TABLE public.traduzioni_stato TO service_role;
GRANT MAINTAIN ON TABLE public.traduzioni_stato TO service_role;
GRANT REFERENCES ON TABLE public.traduzioni_stato TO service_role;
GRANT SELECT ON TABLE public.traduzioni_stato TO service_role;
GRANT TRIGGER ON TABLE public.traduzioni_stato TO service_role;
GRANT TRUNCATE ON TABLE public.traduzioni_stato TO service_role;
GRANT UPDATE ON TABLE public.traduzioni_stato TO service_role;
GRANT DELETE ON TABLE public.trova_errore_scenarios TO anon;
GRANT INSERT ON TABLE public.trova_errore_scenarios TO anon;
GRANT MAINTAIN ON TABLE public.trova_errore_scenarios TO anon;
GRANT REFERENCES ON TABLE public.trova_errore_scenarios TO anon;
GRANT SELECT ON TABLE public.trova_errore_scenarios TO anon;
GRANT TRIGGER ON TABLE public.trova_errore_scenarios TO anon;
GRANT TRUNCATE ON TABLE public.trova_errore_scenarios TO anon;
GRANT UPDATE ON TABLE public.trova_errore_scenarios TO anon;
GRANT DELETE ON TABLE public.trova_errore_scenarios TO authenticated;
GRANT INSERT ON TABLE public.trova_errore_scenarios TO authenticated;
GRANT MAINTAIN ON TABLE public.trova_errore_scenarios TO authenticated;
GRANT REFERENCES ON TABLE public.trova_errore_scenarios TO authenticated;
GRANT SELECT ON TABLE public.trova_errore_scenarios TO authenticated;
GRANT TRIGGER ON TABLE public.trova_errore_scenarios TO authenticated;
GRANT TRUNCATE ON TABLE public.trova_errore_scenarios TO authenticated;
GRANT UPDATE ON TABLE public.trova_errore_scenarios TO authenticated;
GRANT DELETE ON TABLE public.trova_errore_scenarios TO service_role;
GRANT INSERT ON TABLE public.trova_errore_scenarios TO service_role;
GRANT MAINTAIN ON TABLE public.trova_errore_scenarios TO service_role;
GRANT REFERENCES ON TABLE public.trova_errore_scenarios TO service_role;
GRANT SELECT ON TABLE public.trova_errore_scenarios TO service_role;
GRANT TRIGGER ON TABLE public.trova_errore_scenarios TO service_role;
GRANT TRUNCATE ON TABLE public.trova_errore_scenarios TO service_role;
GRANT UPDATE ON TABLE public.trova_errore_scenarios TO service_role;
GRANT DELETE ON TABLE public.weekly_challenges TO anon;
GRANT INSERT ON TABLE public.weekly_challenges TO anon;
GRANT MAINTAIN ON TABLE public.weekly_challenges TO anon;
...
GRANT MAINTAIN ON TABLE public.weekly_challenges TO authenticated;
...
GRANT MAINTAIN ON TABLE public.weekly_challenges TO service_role;
...
GRANT SELECT (xp) ON TABLE public.profiles TO authenticated;
GRANT SELECT (updated_at) ON TABLE public.profiles TO authenticated;
GRANT SELECT (asd_code) ON TABLE public.profiles TO authenticated;
GRANT SELECT (asd_name) ON TABLE public.profiles TO authenticated;
GRANT SELECT (role) ON TABLE public.profiles TO authenticated;
GRANT SELECT (id) ON TABLE public.smazzate TO anon;
GRANT SELECT (id) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (lesson_id) ON TABLE public.smazzate TO anon;
GRANT SELECT (lesson_id) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (board) ON TABLE public.smazzate TO anon;
GRANT SELECT (board) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (title) ON TABLE public.smazzate TO anon;
GRANT SELECT (title) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (contract) ON TABLE public.smazzate TO anon;
GRANT SELECT (contract) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (declarer) ON TABLE public.smazzate TO anon;
GRANT SELECT (declarer) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (vulnerability) ON TABLE public.smazzate TO anon;
GRANT SELECT (vulnerability) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (opening_lead) ON TABLE public.smazzate TO anon;
GRANT SELECT (opening_lead) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (hands) ON TABLE public.smazzate TO anon;
GRANT SELECT (hands) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (bidding) ON TABLE public.smazzate TO anon;
GRANT SELECT (bidding) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (created_at) ON TABLE public.smazzate TO anon;
GRANT SELECT (created_at) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (updated_at) ON TABLE public.smazzate TO anon;
GRANT SELECT (updated_at) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (dd_tricks) ON TABLE public.smazzate TO anon;
GRANT SELECT (dd_tricks) ON TABLE public.smazzate TO authenticated;
GRANT SELECT (title_en) ON TABLE public.smazzate TO anon;
GRANT SELECT (title_en) ON TABLE public.smazzate TO authenticated;

-- PERMESSI ESATTI: FUNZIONI
REVOKE ALL ON FUNCTION public.adesione_invia(p_codice text, p_nome text, p_contatto text, p_note text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.admin_class_detail(p_class_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.admin_game_stats() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.admin_list_classes() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.admin_login_history(p_days integer) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.assegna_lezione(p_class_id uuid, p_lesson_id integer, p_soluzioni text, p_due_date timestamp with time zone) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.aste_giocatore_torneo(p_torneo uuid, p_giocatore uuid) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.aste_giocatore_torneo(p_torneo uuid, p_giocatore uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.aste_giocatore_torneo(p_torneo uuid, p_giocatore uuid) TO service_role;
REVOKE ALL ON FUNCTION public.aula_apri(p_class_id uuid, p_tavoli integer, p_titolo text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.aula_aspetta(p_tavolo_id uuid) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.aula_aspetta(p_tavolo_id uuid) TO anon;
GRANT EXECUTE ON FUNCTION public.aula_aspetta(p_tavolo_id uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.aula_aspetta(p_tavolo_id uuid) TO service_role;
REVOKE ALL ON FUNCTION public.aula_chiudi(p_sessione_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.aula_distribuisci(p_sessione_id uuid, p_hands jsonb, p_titolo text, p_contract text, p_declarer text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.aula_mani_al_turno(p_tavolo_id uuid, p_utente uuid) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.aula_mani_al_turno(p_tavolo_id uuid, p_utente uuid) TO PUBLIC;
GRANT EXECUTE ON FUNCTION public.aula_mani_al_turno(p_tavolo_id uuid, p_utente uuid) TO anon;
GRANT EXECUTE ON FUNCTION public.aula_mani_al_turno(p_tavolo_id uuid, p_utente uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.aula_mani_al_turno(p_tavolo_id uuid, p_utente uuid) TO service_role;
REVOKE ALL ON FUNCTION public.aula_muovi(p_tavolo_id uuid, p_utente uuid, p_posto text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.aula_prossimo_a_uscire(p_tavolo_id uuid) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.aula_prossimo_a_uscire(p_tavolo_id uuid) TO PUBLIC;
GRANT EXECUTE ON FUNCTION public.aula_prossimo_a_uscire(p_tavolo_id uuid) TO anon;
GRANT EXECUTE ON FUNCTION public.aula_prossimo_a_uscire(p_tavolo_id uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.aula_prossimo_a_uscire(p_tavolo_id uuid) TO service_role;
REVOKE ALL ON FUNCTION public.aula_ruota(p_tavolo_id uuid) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.aula_ruota(p_tavolo_id uuid) TO anon;
GRANT EXECUTE ON FUNCTION public.aula_ruota(p_tavolo_id uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.aula_ruota(p_tavolo_id uuid) TO service_role;
REVOKE ALL ON FUNCTION public.aula_siediti(p_tavolo_id uuid, p_posto text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.aula_stato(p_sessione_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.bidding_session_bid_server(p_id uuid, p_bid text) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.bidding_session_bid_server(p_id uuid, p_bid text) TO service_role;
REVOKE ALL ON FUNCTION public.bidding_session_create(p_partner uuid, p_hands jsonb, p_dealer text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.bidding_session_view(p_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.commento_negato(p_smazzata_id text) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.commento_negato(p_smazzata_id text) TO PUBLIC;
...
REVOKE ALL ON FUNCTION public.compito_per_allievo(p_assignment_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.confronto_campo(p_mano_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.confronto_campo_filtrato(p_mano_id uuid, p_filtro text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.confronto_mano(p_assignment_id uuid, p_smazzata_id text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.distribuzione_sondaggio(p_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.genera_codice_amico() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.generate_invite_code() FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.generate_invite_code() TO PUBLIC;
...
REVOKE ALL ON FUNCTION public.get_challenge_history(p_user_id uuid, p_limit integer) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.get_challenge_stats(p_user_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.get_class_leaderboard(p_class_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.get_class_results(p_assignment_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.get_club_leaderboard(p_asd_code text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.get_club_stats(p_asd_code text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.get_daily_field_stats(p_date text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.get_engagement_targets(p_limit integer) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.get_engagement_targets(p_limit integer) TO service_role;
REVOKE ALL ON FUNCTION public.get_game_leaderboard(p_game_type text, p_limit integer) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.get_pending_challenges(p_user_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.get_review_items_state() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.is_bbo_username_taken(p_bbo_username text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.is_curatore() FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.is_curatore() TO PUBLIC;
...
REVOKE ALL ON FUNCTION public.is_instructor_of_assignment(p_assignment_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.is_instructor_of_class(p_class_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.is_member_of_class(p_class_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.is_pending_of_class(p_class_id uuid) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.is_pending_of_class(p_class_id uuid) TO PUBLIC;
...
REVOKE ALL ON FUNCTION public.join_class_by_code(p_code text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.libreria_segna_uso(p_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.licite_in_attesa(p_user uuid, p_ore integer) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.list_instructor_requests(p_status text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.list_partner_candidates(p_level text, p_province text, p_availability text[], p_limit integer) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.live_table_open(p_class_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.live_table_play(p_table_id uuid, p_seat text, p_card jsonb) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.live_table_registra_mano(p_id uuid, p_mano jsonb) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.live_table_undo(p_table_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.live_table_view(p_table_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.log_user_login() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.mie_statistiche_sfide() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.mio_codice_amico() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.my_asd_code() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.my_bidding_sessions() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.segna_uscita_da_classe() FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.segna_uscita_da_classe() TO PUBLIC;
...
REVOKE ALL ON FUNCTION public.sfida_board_chiudi(p_sessione uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.sfida_coppie_coda_stato() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.sfida_coppie_crea(p_compagno uuid, p_b1 uuid, p_b2 uuid, p_quante integer) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.sfida_coppie_esci() FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.sfida_coppie_iscrivi(p_compagno uuid, p_quante integer) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.sfida_coppie_vista(p_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.smazzate_commenti(p_ids text[]) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.stato_compiti_classe(p_class_id uuid) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.sync_asd_name() FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.sync_asd_name() TO PUBLIC;
...
REVOKE ALL ON FUNCTION public.sync_review_items(p_items jsonb, p_expected_revision text) FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.sync_review_items(p_items jsonb, p_expected_revision text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.sync_review_items(p_items jsonb, p_expected_revision text) TO service_role;
REVOKE ALL ON FUNCTION public.tocca_bidding_session() FROM PUBLIC, anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.tocca_bidding_session() TO PUBLIC;
...
REVOKE ALL ON FUNCTION public.torneo_corrente(p_tipo text) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.torneo_mano(p_torneo uuid) FROM PUBLIC, anon, authenticated, service_role;
