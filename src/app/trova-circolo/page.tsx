      ...
      <div className="px-4 -mt-4">
        <div className="mx-auto max-w-2xl">
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl card-elevated p-4 mb-4"
          >
            {/* Search */}
            <div className="relative mb-3">
              ...
              <input
                ...
                className="w-full h-11 pl-10 pr-4 rounded-xl border border-gray-200 bg-gray-50 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#003DA5] focus:border-transparent"
              />
            </div>
            ...
            <button
              ...
              className="flex items-center gap-1 mt-2 text-[11px] text-gray-400 font-bold hover:text-gray-600 transition-colors"
            >
          ...
          <div className="space-y-2">
              ...
              displayedClubs.map((club, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-white rounded-2xl card-clean p-4 hover:shadow-lg transition-shadow"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          {club.active && (
                            <span className="text-[10px] font-bold text-[#003DA5] bg-[#003DA5]/5 px-1.5 py-0.5 rounded">
                              ATTIVO
                            </span>
                          )}
                        </div>
                    ...
                    <div className="flex gap-2 mt-3 pt-3 border-t border-gray-50">
                      <a
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 text-xs font-bold text-[#003DA5] bg-[#003DA5]/5 rounded-lg py-2 hover:bg-[#003DA5]/10 transition-colors"
                      >
                      ...
                      <Link
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 text-xs font-bold text-gray-600 bg-gray-50 rounded-lg py-2 hover:bg-gray-100 transition-colors"
                      >
            ...
            {hasMore && (
              <motion.button
                ...
                className="w-full py-3 text-sm font-bold text-[#003DA5] bg-white rounded-2xl card-clean hover:shadow-lg transition-shadow"
              >
