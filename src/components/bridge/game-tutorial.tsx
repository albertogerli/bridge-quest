        ...
        >
          ...
          <div className={`absolute z-10 ${containerClass}`}>
            ...
            >
              ...
              <div className="bg-card/95 backdrop-blur-md rounded-2xl px-5 py-4 shadow-2xl shadow-black/30 max-w-[280px] w-max">
                {/* Step number badge */}
                <div className="flex items-center gap-2 mb-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-500 text-white text-[12px] font-bold">
                    {currentStep + 1}
                  </span>
