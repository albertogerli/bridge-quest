      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mt-1">Ecco i tuoi progressi!</p>
            ...
            {data.xpEarned > 200 ? (
              ...
              <p className="mt-4 text-sm font-bold text-muted-foreground">Nuova settimana, nuove sfide!</p>
            )}
