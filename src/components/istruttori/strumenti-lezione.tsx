...
import { Archive, ChevronRight, FlaskConical, Presentation, Printer, Users, Wand2 } from "lucide-react";
...
export const STRUMENTI_LEZIONE: Strumento[] = [
  ...
  {
    href: "/istruttori/studio",
    titolo: "Tavolo di studio",
    descrizione: "Cambia una carta e vedi quanto costa, presa per presa",
    icona: FlaskConical,
  },
  {
