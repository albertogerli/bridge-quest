    ...
    <footer className="border-t border-gray-200/60 dark:border-gray-700/40 bg-[#F7F5F0]/80 dark:bg-[#0f1219]/80 backdrop-blur-sm">
      <div className="mx-auto max-w-5xl px-5 py-6">
        ...
        <div className="flex items-center justify-center gap-4 mb-4">
          <img src="/logo-bridgelab.svg" alt="BridgeLab" className="h-6 w-auto opacity-60" />
          <div className="h-4 w-px bg-gray-300 dark:bg-gray-600" />
          <img src="/icons/logo-figb.png" alt="FIGB" className="h-7 w-auto opacity-60" />
          <img src="/icons/logo-coni.png" alt="CONI" className="h-5 w-auto opacity-60" />
        </div>
