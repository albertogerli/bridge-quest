...
const tema1: EserciziarioExercise[] = [
  {
    ...
    content: [
      ...
      {
        type: "quiz",
        content: "Quand'è che un giocatore scarta?",
        options: [
        ...
        correctAnswer: 0,
        explanation: "Si scarta quando non si hanno più carte nel seme dominante della presa in corso.",
      },
      {
        type: "quiz",
        content: "Quand'è che il primo di mano scarta?",
        options: [
          "Quando vuole",
        ...
        correctAnswer: 1,
        explanation: "Mai! Il primo di mano non scarta: è lui a decidere il seme della presa.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 3,
        explanation: "Nessuna è affrancabile perché sono già tutte vincenti! AKQJ sono le 4 carte più alte del seme.",
      },
      {
        type: "quiz",
        content: "In una presa vengono giocati l'8, il J, la Q e l'Asso. Qual è l'ordine delle tre carte più alte tra quelle rimaste?",
        options: ["K, 10, 9", "K, Q, J", "A, K, Q", "10, 9, 8"],
        correctAnswer: 0,
        explanation: "L'Asso, la Q e il J sono già usciti. Le tre carte più alte rimaste sono K, 10, 9.",
      },
      {
        type: "quiz",
      ...
      {
        type: "quiz",
        content: "Nel corso di una presa, chi ha più vantaggi tra i quattro giocatori?",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "a) 6 vincenti/equivalenti (AKQJ109). b) Solo 3 prese perché abbiamo 3 carte per lato.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "a) 5: AKQJ10. b) 5, perché Sud ha 5 carte.",
      },
      {
        type: "quiz",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation: "150: 40 la presa dichiarata + 60 le due prese in più + 50 di bonus parziale.",
      },
      {
        type: "quiz",
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        content: "In Sud vedete il Morto e prevedete di fare tantissime prese. Qual è l'attacco peggiore che potreste ricevere?",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "Quadri! Obbligandovi a usare subito l'Asso del morto, non riuscirete più a incassare tutte le fiori di Nord.",
      },
    ],
  },
];
...
const tema2: EserciziarioExercise[] = [
  {
    ...
    content: [
      ...
      {
        type: "quiz",
        content: "Un giocatore possiede ♣KQJ53. Che carta deve giocare se è primo di mano? E se è terzo?",
        options: [
        ...
        correctAnswer: 0,
        explanation: "Il Re quando è in prima posizione (alto dalla sequenza), il Fante quando è in terza posizione (basso dalla sequenza).",
      },
      {
        type: "quiz",
      ...
      {
        type: "true-false",
        content: "L'attacco con il J mostra che quel giocatore NON possiede carte più alte del Fante.",
        correctAnswer: 1,
        explanation: "Falso! Potrebbe avere AJ10x o KJ10x. Quel che è certo è che non ha la Dama.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "Q♣: colore più lungo con sequenza QJ.",
      },
      {
        type: "bid-select",
        ...
        correctAnswer: 0,
        explanation: "4♦: colore lungo senza onori toccati, la scelta più sicura.",
      },
      {
        type: "bid-select",
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "4♦: colore quinto con possibilità di affrancamento.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        cards: "♠K♠J♠9",
        correctCard: "♠9",
        explanation: "Il 9. La Q del morto copre il J e il K; il 9 è sufficiente.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "Ovest ha sbagliato attaccando con il 5 anziché il 10 (sequenza). Se avesse giocato il 10, Est avrebbe salvato la Dama.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "Est! Sa perfettamente che la Dama è in mano a Sud (l'attacco di J la nega), quindi DEVE mettere il Re!",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "Est! Re e Fante non sono equivalenti. Poiché è suo dovere cercare di vincere la presa, la carta da giocare è quella più alta: il Re.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "Sud con AQ avrebbe preso con la Dama. Quindi la Q è in Est. Il 9 è in Sud, perché Est con 10 e 9 avrebbe giocato il 9.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "Se Est avesse avuto K e J, avrebbe giocato il Re. Quindi il Re è in Sud. Anche il 10 è in Sud.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "quiz",
        content: "Nord: 643, Ovest: AQ10. Quante prese minime vi spettano?",
        options: ["1", "2", "3", "4"],
        correctAnswer: 2,
        explanation: "3: sempre che non ci muoviamo per primi. Il giocante non può evitare di darci 3 prese.",
      },
      {
        type: "quiz",
        content: "Nord: A65, Ovest: Q102. Quante prese minime vi spettano?",
        options: ["0", "1", "2", "3"],
        correctAnswer: 1,
        explanation: "1: se Sud gioca il Fante, basterà coprirlo con la Dama.",
      },
      {
        type: "quiz",
        content: "Nord: J10, Ovest: AQ94. Quante prese minime vi spettano?",
        options: ["1", "2", "3", "4"],
        correctAnswer: 2,
      ...
      {
        type: "quiz",
        content: "Nord: QJ, Ovest: A1062. Quante prese minime vi spettano?",
        options: ["1", "2", "3", "4"],
        correctAnswer: 1,
        explanation: "2: anche il 10 vincerà la sua presa, comunque giochi Sud.",
      },
      {
        type: "quiz",
        content: "Nord: AK7, Ovest: QJ9. Quante prese minime vi spettano?",
        options: ["0", "1", "2", "3"],
        correctAnswer: 1,
        explanation: "1: basterà giocare il 9 se Sud muove piccola, e coprire con un pezzo se Sud muove il 10.",
      },
      {
        type: "quiz",
        content: "Nord: 543, Ovest: AJ108. Quante prese minime vi spettano?",
        options: ["1", "2", "3", "4"],
        correctAnswer: 2,
...
const tema3: EserciziarioExercise[] = [
  {
    ...
    content: [
      {
        type: "text",
        content: "Tra mano e morto avete il numero di carte indicato; scrivete le due divisioni dei resti più probabili.",
      },
      {
        type: "quiz",
        content: "7 carte in linea (ne mancano 6). Divisioni più probabili?",
        options: ["3-3 e 4-2", "5-1 e 6-0", "4-2 e 5-1", "2-4 e 1-5"],
        correctAnswer: 0,
        explanation: "Con 6 carte mancanti: divisioni più probabili 3-3 e 4-2.",
      },
      {
        type: "quiz",
        content: "6 carte in linea (ne mancano 7). Divisioni più probabili?",
      ...
      {
        type: "quiz",
        content: "9 carte in linea (ne mancano 4). Divisioni più probabili?",
      ...
      {
        type: "quiz",
        content: "8 carte in linea (ne mancano 5). Divisioni più probabili?",
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        content: "È possibile affrancare prese di lunga? Quante con la divisione dei resti più vantaggiosa?",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "Sì, TRE prese di lunga se diviso 2-1 (10 carte, ne mancano solo 3).",
      },
      {
        type: "quiz",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "a) Nessuna di forza (mancano Q e J). b) 4 se 2-2. c) Sì.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "a) Due (abbiamo KQJ). b) DUE se 3-2. c) Sì.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "a) Nessuna di forza extra. b) DUE se 3-3. c) Sì.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "a) QUATTRO (manca solo l'A). b) Nessuna in più. c) No.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "a) DUE (QJ contro AK). b) Nessuna in più. c) No.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        content: "Indicate le carte che potrebbero darvi una presa in più (oltre a quelle franche).",
      },
      {
        type: "quiz",
        content: "Nord: KJ5 / Sud: A64. Quale carta può dare una presa in più?",
        options: ["Il J di Nord", "Il K di Nord", "Il 6 di Sud", "Nessuna"],
        correctAnswer: 0,
        explanation: "Il Fante di Nord: se la Q è in Ovest, con l'impasse il J diventa vincente.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "La Dama di Nord: se il K è in Ovest.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "Il Re di Nord: se l'A è in Ovest.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "La Dama di Sud: se il K è in Ovest.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "Il Fante di Sud: se la Q cade sotto AK, o se è in posizione favorevole.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "K in Est: faremo l'impasse più volte e realizzeremo tutte le prese.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "Dovunque, purché secco! Con 10 carte, il K cadrà sotto l'A.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "In Ovest! Giocheremo cartina verso la Dama: Est farà il suo Re, o subito o dopo, ma la Dama si affrancherà.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "In Ovest: giocheremo piccola verso la Dama. Ovest farà il Re, ma la Dama si affrancherà.",
      },
    ],
  },
  {
...
const tema4: EserciziarioExercise[] = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "Il taglio (ruff) è giocare una carta di atout quando non si possiede il seme della presa.",
      },
      {
        type: "quiz",
        ...
        correctAnswer: 0,
        explanation: "Tagliare nella mano lunga non crea prese extra. È meglio tagliare nella mano corta.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "quiz",
        content: "In un contratto ad atout, qual è il primo passo del piano di gioco?",
        options: [
...
const tema5: EserciziarioExercise[] = [
  {
    ...
    content: [
      ...
      {
        type: "quiz",
        content: "In un contratto a SA, qual è il primo passo del piano di gioco?",
        options: [
      ...
      {
        type: "quiz",
        content: "Perché a SA è importante l'affrancamento?",
        options: [
        ...
        correctAnswer: 0,
        explanation: "Senza atout non si può tagliare, quindi l'affrancamento è la tecnica principale per creare prese.",
      },
      {
        type: "quiz",
    ...
    content: [
      {
        ...
        correctAnswer: 0,
        explanation: "Un rientro è una carta alta in una mano che ci consente di trasferire il gioco a quella mano.",
      },
      {
        type: "quiz",
        content: "Perché i rientri sono fondamentali a SA?",
        options: [
...
const tema6: EserciziarioExercise[] = [
  {
    ...
    content: [
      ...
      {
        type: "quiz",
        content: "Con fit 4-4 in atout, è più vantaggioso tagliare dove?",
        options: [
        ...
        correctAnswer: 0,
        explanation: "Con fit 4-4, tagliare nella mano corta (morto) crea prese extra. La mano lunga le aveva già.",
      },
    ],
  },
];
...
const tema9: EserciziarioExercise[] = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "Con 3+ carte nel seme del partner e 6-9 PO si dà l'appoggio semplice (2♥).",
      },
      {
        type: "quiz",
      ...
      {
        type: "quiz",
        content: "Qual è il significato della risposta 1SA sull'apertura 1 a colore?",
        options: [
        ...
        correctAnswer: 0,
        explanation: "1SA = 6-9 PO, risposta di ripiego quando non si può appoggiare né nominare un colore.",
      },
    ],
  },
];
...
const tema10: EserciziarioExercise[] = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "Con 14 PO siete in fascia minima (12-15). Ridichiarate al livello più basso senza forzare.",
      },
      {
        type: "quiz",
...
const tema11: EserciziarioExercise[] = [
  {
    ...
    content: [
      ...
      {
        type: "quiz",
        content: "L'avversario destro apre 1♥. Cos'è un 'intervento'?",
        options: [
        ...
        correctAnswer: 0,
        explanation: "L'intervento è una dichiarazione competitiva fatta dopo l'apertura dell'avversario.",
      },
      {
        type: "quiz",
        content: "Quando è opportuno intervenire a colore?",
        options: [
      ...
      {
        type: "quiz",
        content: "Cos'è il 'Contre' (X) informativo?",
        options: [
...
const tema12: EserciziarioExercise[] = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation: "Con fit e 6-9 PO si dà appoggio semplice, come senza intervento.",
      },
      {
        type: "quiz",
        content: "Cos'è il 'Contre' del rispondente sull'intervento avversario?",
        options: [
      ...
      {
        type: "quiz",
        content: "Perché la dichiarazione competitiva è importante?",
        options: [
