...
export const smazzate: Smazzata[] = [
  ...
  // --- Board 1 ---
  {
    ...
    commentary:
      "Est sceglie il suo miglior colore e seleziona la Dama; Ovest potrà dedurre che Est ha sicuramente il Fante, ma non ha assolutamente il Re. Il Gioco. Nord conta: 2 prese certe a picche, 1 a cuori, 1 a fiori. Altre 5 prese sono a disposizione, con certezza quasi assoluta, nel colore di quadri, in quanto Sud ha 5 carte e tra Nord e Sud vi sono le 5 carte più alte del colore. Ma è necessario un piccolo spreco: Nord deve incassare per primo uno dei suoi onori di quadri, poi deve giocare l'altro e superarlo con l'Asso del morto. Solo così potrà proseguire incassando anche J,10 e 5. Infine incasserà le vincenti negli altri colori. 3NT, in prima: 400 (40+30+30 le prese dichiarate, + 300 di Bonus di manche)",
  ...
  // --- Board 2 ---
  {
    ...
    commentary:
      "Sud sceglie il suo colore più lungo e intavola la Dama; questo attacco promuove il Fante e nega il Re. Il Gioco. Est può contare su 7 vincenti già disponibili: 1 a picche, 1 a cuori, e 5 a fiori, purché le 5 carte restanti non siano tutte in mano allo stesso avversario. Non avrà difficoltà a mantenere il contratto, purché le fiori siano mosse correttamente: prima l'Asso ed il Re, poi la cartina per incassare le fiori restanti. 1NT, 90 (40 la presa dichiarata, + 50 di bonus del parziale)",
  ...
  // --- Board 3 ---
  {
    ...
    commentary:
      "Attacco: 2 di fiori. Est deve giocare il suo Re. Sud ha a disposizione 5 vincenti: 3 a picche, 1 a cuori, 1 a fiori. Le quadri, sorgente di prese, presentano ben cinque carte equivalenti, tra mano e morto: basterà giocare una di queste (meglio iniziare con la Q o il 9) e insistere finché non scende l'Asso, per ottenere altre 4 prese affrancate. Sarebbe un errore grave iniziare con AKQ di picche: Est, quando entrerà in presa con l'Asso di quadri, avrà 3 picche franche, che aggiunte alla Dama di fiori batteranno il contratto: sotto di una. 3NT+1, in prima, 430 punti (40+30+30 le prese dichiarate, + 30 la presa in più, + 300 di bonus di manche)",
  ...
  // --- Board 5 ---
  {
    ...
    commentary:
      "Est attacca J di cuori (la figura di cuori e picche sono più solide). Il gioco. Nord conta 2 prese a picche, 3 a cuori, 6 a quadri, 1 a fiori: 12! Preso l'attacco con l'Asso si dedica subito al colore di quadri... facendo attenzione: è assolutamente necessario che la TERZA presa (quella in cui saranno esaurite le quadri di Nord) sia vinta dalla Dama di Sud; solo così potrà continuare ad incassare le altre quadri. Quindi i primi onori da usare sono Asso e Re, poi il Fante... avendo cura di superarlo con la Dama! 6NT, in seconda: 1440 (190 le prese dichiarate + 500 di bonus di manche in zona + 750 di bonus di Piccolo Slam in zona)",
  ...
  // --- Board 6 ---
  {
    ...
    commentary:
      "Il gioco. L'attacco non disturba... ma il rinvio si! Se Nord si guarda le carte si accorge che può battere il contratto, prendendo con l'Asso di picche e giocando il Re di cuori. Quando Est dovrà cedere l'Asso di quadri, Nord potrà incassare le cuori affrancate e guadagnare 100 punti (una sotto: 1 picche, 3 cuori e 1 quadri). Se Nord sonnecchia... Est avrà il tempo per affrancare 4 prese a picche, da sommare a 4 fiori, la cuori, e le due picche. 3NT - 1: -100. Se il controgioco è difettoso... 3NT+2: 660 (100 le prese dichiarate, + 60 per le due prese in più, + 500 di bonus di manche in zona)",
  ...
  // --- Board 7 ---
  {
    ...
    commentary:
      "Ovest attacca con l'Asso di quadri e, vedendo al morto Q9, sa di poter incassare almeno tre prese a quadri di fila, quindi prosegue con il K, il J ed il 7, preso da Est con l'8. Ora Est ha altre due prese a fiori da incassare. Tutto facile per la difesa, ma la domanda è: cosa ha scartato Sud, dalla mano e dal morto? Sud non ha difficoltà, sul quarto giro di quadri scarta fiori. Il morto... NON deve scartare picche (farà 5 prese nel colore, ma solo se le conserva tutte); NON DEVE scartare il 3 di fiori (altrimenti Est farà 4 prese e non due). Può tranquillamente scartare due cuori, che non hanno influenza sulle prese che ha a disposizione nel colore. 1NT: 90 (40 per la presa dichiarata, + 50 di bonus del parziale). Oppure 1SA - 1, o - 2, se ha scartato male (-100, - 200)",
  ...
  // --- Board 8 ---
  {
    ...
    commentary:
      "L'attacco di Fante aiuta Sud a fare la cosa giusta: metterà il Re se viene giocata la Dama, e... lascerà lavorare il Fante se il morto sta basso. Il gioco. Ci sono 13 vincenti: 4 a picche, 3 a cuori, 5 a quadri, 1 a fiori. Ma occorre muoversi con accortezza, le cose non sono mai facili quando una delle due mani è ricchissima e l'altra è povera. Ovest deve prendere l'attacco, incassare AKQ di quadri e KQ di cuori, dare la presa al morto giocando il 2 di fiori per il Fante e proseguire con le altre due quadri e l'Asso di cuori. Poi tornerà 'in mano' per terminare con AKQ di picche: 13 prese. 7NT, in prima: 1520 (220 per le prese dichiarate + 300 bonus di manche + 1000 bonus Grande slam in prima).",
  ...
  // --- Board 2 ---
  {
    ...
    commentary:
      "Attacco facile: Asso di cuori, poi Re...poi Dama.. e poi le altre due carte, per un totale di 5 prese veloci e contratto battuto. Ma c'è una trappola: Nord, quando vede cadere il Fante nella prima presa, non ha ancora la certezza che sia l'unica carta di Est. Ma quando lo vede scartare, sulla seconda presa, conosce perfettamente la distribuzione e le carte di Sud! Deve quindi fare attenzione a non affezionarsi egoisticamente al suo 9, anzi lo deve assolutamente buttar via quando Sud incassa la Dama, altrimenti Sud non farà mai la quinta carta e Est manterrà il contratto con 3 picche, 5 quadri (AJ i primi onori da giocare), e 1 fiori. 3NT -1, in prima: -50. Oppure 3NT in prima: 400 (100 per le prese + 300 di Bonus)",
    bidding: { dealer: "west", bids: ["1NT", "P", "3NT", "P", "P", "P"] },
  },
  ...
  // --- Board 3 ---
  {
    ...
    commentary:
      "Attacco 2 di picche, Est gioca il 10, la più bassa delle equivalenti. Il gioco. Questa smazzata può avere esiti diversi: - se Ovest inizia con AK di fiori, Sud farà 9 prese senza fatica. - se Ovest gioca un solo onore di fiori, poi gioca picche, Sud farà ancora 9 prese se rigioca fiori immediatamente per completare l'affrancamento - se Ovest attacca a picche, e dalla prima presa (7-10-K) si accorge che il J è in Est, e continua con il 4 di picche quando entra in presa a fiori (evitando di incassare anche l'altro onore)...il contratto cadrà. Ogni linea possiede AK nel colore dell'avversario; vince la corsa chi ha incominciato prima: Est-Ovest. 3NT - 1, in prima: -50. Oppure 3NT in prima 400 (100 per le prese + 300 di Bonus)",
  ...
  // --- Board 4 ---
  {
    ...
    commentary:
      "Attacco 2 di picche, la più alta delle toccanti di Nord, facendo sequenza l'attacco è fatto con una cartina di coda. La prima presa è illuminante: Sud inserisce il Fante e Ovest prende con l'Asso; per Nord è tutto chiaro, la logica - e gli accordi - assegnano la dama di picche a Sud con certezza assoluta. Quindi, quando entrerà in presa con l'Asso di quadri, rigiocherà una piccola picche e non il Re: solo così la sua coppia potrà incassare facilmente 4 prese, e battere il contratto. 3NT - 1, in seconda: -100. Oppure 3NT + 1, in seconda: 630 (130 per le prese, + 500 di bonus)",
    bidding: { dealer: "west", bids: ["1NT", "P", "3NT", "P", "P", "P"] },
  },
  ...
  // --- Board 5 ---
  {
    ...
    commentary:
      "Attacco....è il vero problema: sono in ballo 1440 punti e tutto dipende dall'attacco di Est! Se la scelta cade sulle picche (J), o sull'asso di fiori, o sulle quadri (?), Nord manterrà il contratto: gli spettano 3 picche, 1 cuori, 5 quadri e può trovare 3 affrancabili a fiori (colore che muoverà per primo, appena potrà prendere). Ma non se l'attacco è Re di cuori: Est entrerà prima o poi in presa con l'Asso di fiori, e incasserà la Dama di cuori: una sotto. Può Est prevedere questo, quando sceglie l'attacco? Certamente sì, gli bastano due prese per battere lo Slam, e a cuori sarebbe stato l'attacco corretto. Se il contratto fosse stato 1NT, o 3NT, picche sarebbe stato l'attacco corretto. 6NT - 1, in seconda: -100. Oppure 6NT, in seconda: 1440 (190 le prese, + 600 bonus di manche, + 750 bonus di Slam)",
    bidding: { dealer: "north", bids: ["2NT", "P", "6NT", "P", "P", "P"] },
  },
  ...
  // --- Board 8 ---
  {
    ...
    commentary:
      "Attacco: J di quadri, la più alta delle toccanti. L'attacco di Fante nega la Dama (quindi Sud sa con certezza che la Dama è in Ovest) ma non esclude un onore più alto, in cima al colore. Per questo motivo Sud DEVE giocare il suo Re nella prima presa, intanto: - se Ovest ha AQ, farà 2 prese in ogni caso, e non di più- se Ovest ha la Dama, ma non l'Asso, non mettere il Re sarebbe disastroso! Ovest non può far nulla... a meno che Sud sbagli e gli lasci vincere la prima presa. In tal caso inizierà incassando Asso e Re di fiori, e accorgendosi di come sono divise rigiocherà il 6... superando di misura la carta di Nord. Farà così 5 a quadri 1 cuori, 2 cuori. 1NT - 1, in prima: -50. Oppure 1NT+1, in prima: 120 (70 le prese, + 50 di bonus)",
  ...
  // --- Board 3 ---
  {
    ...
    commentary:
      "Attacco: J di cuori, la più alta delle toccanti del miglior colore di Ovest. Il gioco. Sud ha 8 vincenti, facili da contare: 2 picche, 3 cuori, 1 quadri e 2 fiori. È anche facile individuare il colore in cui affrancarne almeno una: quadri. Vinto l'attacco Sud, resistendo a ogni tentazione, gioca immediatamente l'asso di quadri e ancora quadri. Vincerà Est, e qualunque sia il suo rinvio Sud ostinatamente proseguirà a quadri. Ora avrà in mano due cartine affrancate, da aggiungere alle 8 vincenti già conteggiate. 3NT + 2, in prima: 460 (160 le prese + 300 di bonus). Se Sud, ignorando le brutte quadri, ha fatto la cicala e ha incassato un po' di vincenti a caso, metta da parte il manuale e si rilegga La Fontaine: tra cicale e formiche non c'è corsa!",
  ...
  // --- Board 5 ---
  {
    ...
    commentary:
      "Attacco 10 di picche, la più alta della sequenza. Il gioco. La forza in linea è molto sbilanciata, eppure Sud porta una sorgente di prese, nella lunga di quadri. Nord ha solo 7 vincenti, deve sperare di affrancare il colore del morto augurandosi che le quadri siano divise 3-2: otterranno 2 prese di lunga. Ma come andrà ad incassarle? Il solo passaggio dalla mano al morto è dato solo dal 7 di fiori, superabile con la Q o il J. Se avete lasciato vincere la prima presa al morto, siete fritti. Superate il J con il K, giocate A e K di quadri e fiori. Qualunque sia il ritorno, il prezioso 7 di fiori vi consentirà di andare al morto a incassare le quadri affrancate. 3NT, in seconda: 600 (100 le prese + 500 di bonus)",
  ...
  // --- Board 7 ---
  {
    ...
    commentary:
      "Attacco facile: J di cuori, la più alta delle toccanti. Il gioco. Le vincenti sono 6: 4 a picche, 1 a cuori, 1 a quadri. Sud deve provare a mettere la Q del morto (o fa presa ora, se Ovest ha KJ10x, o mai più) ma Est la copre con il Re. Pazienza, ora però diventa indispensabile ottenere 4 prese dalle quadri; serve il Re in Est, e poiché Q,J,10 devono fare ognuno una presa l'impasse andrà ripetuto più volte. Quindi, servono tre ingressi. Ci sono, se usate con cura le picche: l'8 superato dal 9 e primo impasse a quadri. Poi J superato dal Re, altro impasse. Poi Dama superata dall'Asso, incasso della quarta picche (altrimenti non la fate più), e ultimo impasse a quadri: 9 prese! 3NT, in seconda: 600 (100 le prese, + 500 di bonus)",
    bidding: { dealer: "south", bids: ["1NT", "P", "3NT", "P", "P", "P"] },
  },
  ...
  // --- Board 1 ---
  {
    ...
    commentary:
      "Attacco Q di picche, la più alta della sequenza. Il gioco. Con il Re di picche sparisce uno dei pochissimi ingressi al morto, resta solo il Re di quadri. E quadri... è il colore da affrancare: Nord conta su 2 picche, 4 fiori (bloccate) e 2 quadri... ma se sono 3-2 potrà ricavare altre 2 prese dal colore. Nessuna illusione sulle cuori: si farà una presa, ma solo se saranno gli avversari a muoverlo per primi. Il collegamento 'interno' a quadri va assolutamente mantenuto, quindi Nord dovrà cedere la prima (o la seconda) presa, a sua scelta. E sbloccare AKQ di fiori prima di trasferirsi al morto. 3NT+1, in prima: 430 (130 le prese, + 300 di bonus)",
    bidding: { dealer: "north", bids: ["1C", "P", "1D", "P", "2NT", "P", "3NT", "P", "P", "P"] },
  },
  ...
  // --- Board 2 ---
  {
    ...
    commentary:
      "Attacco: Q di cuori, che promuove il J ed almeno il 9. Il gioco. Est deve ragionare su quello che vorrà fare, PRIMA di decidere se vincere la presa in mano o al morto. Ha 6 vincenti e i soli due colori presentano affrancabili: le quadri (se divise 3-2 si affrancano 2 prese dopo averne ceduta una) o le fiori (se divise 3-3, evento più raro della 3-2, si affrancherà una presa dopo averne ceduta una). Entrambe le risorse sono al morto, quindi... il Re di cuori va lasciato lì! Vinto l'attacco in mano Est deve giocare AK di quadri e fiori. Nord si sfogerà con le sue 4 prese a picche, ma quando Est vincerà qualsiasi ritorno avrà modo di tornare al morto con il K di cuori ed incassare altre 2 quadri. 1NT + 1: 120 (70 le prese, + 50 di bonus)",
    bidding: { dealer: "east", bids: ["1NT", "P", "P", "P"] },
  },
  ...
  // --- Board 3 ---
  {
    ...
    commentary:
      "Attacco 10 di cuori, la più alta delle toccanti da sequenza interrotta. Il gioco. Finalmente, 9 prese pronte! 1 picche, 2 cuori e 6 quadri. Ma una trappola mortale mette alla prova l'ingordigia di Sud: se non si accorge che le quadri sono bloccate, che il Re di cuori è l'unico ingresso al morto, e che un Asso non può essere superato da un Re, vincerà la prima presa con il Fante. Poi si metterà a pensare... ma sarà tardi! Quindi: rinunciare al regalo e prendere l'Asso, incassare AK di quadri, trasferirsi al morto superando il Fante di cuori con il Re e proseguire con le 4 quadri affrancate. 3NT, in prima: 400 (100 le prese + 300 di bonus)",
  ...
  // --- Board 4 ---
  {
    ...
    commentary:
      "Attacco 4 di picche. Sud inpegna il Fante. Il gioco. Vinto l'attacco, Ovest può stare tranquillo: 2 picche, 2 cuori, 1 fiori e 4 o 5 quadri, a seconda che riesca o meno l'impasse al Re. Va al morto a cuori ed intavola il J di quadri (non il 3!), in modo da poter ripetere l'impasse qualora il K fosse in Sud. Così non è, ma ormai Ovest ha le sue 9 prese. Il controgioco. Nella prima presa Nord si deve accorgere che AK10 di picche sono tutti in mano al giocante (Sud ha giocato il J: non ha né il 10 né un onore alto). Quindi, quando sarà in presa, dovrà scegliere tra cuori e fiori (Ovest farà le sue 9 prese)... ma NON deve più muoversi a picche, altrimenti Ovest farà una presa in più: il 10 di picche. 3NT, in seconda: 600 (100 le prese, + 500 di bonus)",
  ...
  // --- Board 6 ---
  {
    ...
    commentary:
      "Attacco 2 di cuori, una carta piccola che promette uno o più onori (senza sequenza). Il gioco. La prima presa è fondamentale: con Jx per Qxx Est è CERTO di fare prima o poi una presa... a patto che non metta il Fante del morto (Nord prende e rigioca cuori, e Sud Deve giocare la piccola, visto che ha la Dama in mano! Nord se vuole prende e muove ancora cuori, ma ad Est ora spetta una presa. Dovrà, però, incassare velocemente tutte le altre: ha a disposizione 3 picche, 1 cuori, 2 quadri e verosimilmente 4 fiori, che vanno incassate inziando con Asso e Dama, salvando la forchetta di K10 nell'eventualità del Fante quarto in Nord. È proprio questo il caso, ma, poco male, si fa l'impasse! 3NT + 1, in seconda: 630 (130 le prese + 500 di bonus)",
    bidding: { dealer: "west", bids: ["1D", "P", "1NT", "P", "3NT", "P", "P", "P"] },
  },
  ...
  // --- Board 7 ---
  {
    ...
    commentary:
      "Attacco: 2 di picche, cartina che promuove uno o più onori e nega sequenze. Il controgioco. Questo contratto è destinato a cadere, se i difensori lavorano bene: quando Est vince la prima presa con il Re, Ovest si deve accorgere che NON ha la Dama. Est rigioca picche... e Ovest deve rinunciare a prendere (colpo in bianco), perché sa che non entrerà più in presa; deve sperare che entri Est, ma se Est non avrà più picche... non potrà più giocare il colore. Sud è in balia degli avversari; proverà a fare l'impasse a quadri, e manterrà il contratto solo se Ovest non ha resistito alla tentazione di vincere la seconda presa a picche. 3NT-1, in seconda: -100. Oppure 3NT+1, in seconda: 630 (130 le prese + 500 di bonus)",
    bidding: { dealer: "south", bids: ["1NT", "P", "3NT", "P", "P", "P"] },
  },
  ...
  // --- Board 8 ---
  {
    ...
    commentary:
      "Attacco Q di picche, che promuove il J ed almeno il 9. Il gioco. Ovest conta le prese: 2 picche, 2 cuori, 4 fiori, ... e per arrivare a 12 prese non ci sono santi, è necessario fare 4 prese a quadri. L'impasse va fatto, subito. Purtroppo non ci sono carte alte di quadri al morto su cui appoggiarsi, quindi per ripetere questo impasse il maggior numero possibile di volte servono altri due ingressi in Est. Ci sono, a fiori: vinta la presa con il 10 di quadri. Ovest incassa A e K di fiori... e constatata la 3-2 giocherà il FANTE superato con la DAMA, per fare il secondo impasse a quadri. Ancora al morto con l'OTTO di fiori superato dal NOVE... e terzo e ultimo impasse a quadri: 12 prese. 6NT, in prima: 990 (190 le prese + 300 di bonus manche + 500 di bonus Slam)",
