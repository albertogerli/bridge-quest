...
export const errorScenarios: ErrorScenario[] = [
  ...
  // ============================================================
  {
    ...
    difficulty: "facile",
    situation:
      "Sud ha aperto 1NT con questa mano. Qual è l'errore?",
  ...
  },
  {
    ...
    difficulty: "facile",
    situation:
      "Sud con questa mano ha passato. Qual è l'errore?",
    ...
    correctAnswer: 1,
    explanation:
      "La mano ha 14 HCP: ♠A+Q = 6, ♥K+J = 4, ♦A = 4. Totale 14. Con 12+ HCP si deve aprire. Con 4-4 nei nobili e distribuzione 4-4-3-2, si apre del nobile più basso di rango: 1♥ (regola FIGB: con due quarte nobili si apre 1♥).",
  },
  {
    id: 3,
    category: "licita",
    difficulty: "facile",
    situation:
      "Sud ha aperto 2NT con questa mano. Qual è l'errore?",
    ...
    correctAnswer: 1,
    explanation:
      "La mano ha 16 HCP: ♠K+Q = 5, ♥A+J = 5, ♦K+J = 4, ♣Q = 2. Totale 16. Per aprire 2NT servono 21-22 HCP bilanciati. Con 15-17 bilanciata l'apertura corretta è 1NT.",
  },
  {
    id: 4,
    category: "licita",
    difficulty: "facile",
    situation:
      "Sud ha aperto 1♠ con questa mano. Qual è l'errore?",
    ...
    correctAnswer: 2,
    explanation:
      "La mano ha 13 HCP: ♠K+J = 4, ♥A+Q = 6, ♦K = 3. Totale 13. Punti sufficienti per aprire, ma con 4 picche e 4 cuori (due quarte nobili) la regola FIGB è chiara: si apre nel più basso di rango, cioè 1♥. Questo permette al compagno di mostrare le picche a livello 1.",
  },
  {
    id: 5,
    category: "gioco",
    difficulty: "facile",
    situation:
      "Contratto 3NT. Al morto: ♦AKQ73. In mano: ♦J2. Il dichiarante gioca l'Asso dal morto, poi il Re, poi la Donna. Alla terza presa resta ♦73 al morto e niente in mano. Qual è l'errore?",
    ...
    correctAnswer: 0,
    explanation:
      "Regola fondamentale: si giocano gli onori dal LATO CORTO per primo. Bisognava giocare il J dalla mano (lato corto con 2 carte), poi il 2 per A-K-Q del morto. Così si fanno 5 prese in quadri senza bloccare il colore. Giocando AKQ dal morto, il J cade sotto un onore e le carte 7-3 restano irraggiungibili.",
  },
  {
    id: 6,
    category: "licita",
    difficulty: "facile",
    situation:
      "Nord apre 1NT (15-17). Sud risponde 2♣ Stayman con questa mano. Qual è l'errore?",
    ...
    correctAnswer: 1,
    explanation:
      "La Stayman (2♣) richiede almeno 8 HCP e almeno 4 carte in un colore nobile. Questa mano ha solo 3 HCP (♥J = 1, ♦Q = 2) e nessun maggiore quarto. Con mano così debole senza fit nobile, l'unica risposta sensata è Passo su 1NT.",
  },
  {
    id: 7,
    category: "licita",
    difficulty: "facile",
    situation:
      "Sud apre 1♣ con questa mano. Qual è l'errore?",
    ...
    correctAnswer: 0,
    explanation:
      "La mano ha 13 HCP: ♠Q = 2, ♥A = 4, ♦K+J = 4, ♣K = 3. Totale 13. Con 4 quadri e 3 fiori, si apre del minore più lungo: 1♦. Si apre 1♣ solo con minori uguali (3-3 o 4-4). Nota: con distribuzione 3-3-4-3 e 13 HCP, non si può aprire 1NT (servono 15-17).",
  },
  {
    id: 8,
    category: "licita",
    difficulty: "facile",
    situation:
      "Nord apre 1♠. Est passa. Sud ha soli 4 HCP e risponde 1NT. Qual è l'errore?",
    ...
    correctAnswer: 2,
    explanation:
      "Con soli 4 HCP (♥J = 1, ♦Q = 2, ♣J = 1) si deve dire Passo. Per rispondere al compagno che apre di 1 a colore servono almeno 5 HCP. Con meno di 5 la manche (25 HCP in coppia) è irraggiungibile anche se l'apertore ha il massimo (20).",
  },
  {
    id: 9,
    category: "gioco",
    difficulty: "facile",
    situation:
      "Contratto 4♥. Il dichiarante ha 5 atout in mano (♥AKQ83) e 3 al morto (♥J74). Ha anche ♦AK974 al morto da incassare. Invece di battere le atout, gioca subito le quadri. Ovest taglia la terza quadri. Qual è l'errore?",
    ...
    correctAnswer: 1,
    explanation:
      "Con vincenti lunghe da incassare in un colore laterale (♦AK974 al morto), la regola è: PRIMA battere le atout avversarie, POI incassare le vincenti. Se non si tolgono le atout nemiche, un avversario corto a quadri taglia le vostre vincenti. Con 8 atout in linea (5+3), bastano 2-3 giri per eliminare le atout avversarie.",
  },
  {
    id: 10,
    category: "licita",
    difficulty: "facile",
    situation:
      "Sud apre 2♣ forte con questa mano. Qual è l'errore?",
    ...
    correctAnswer: 0,
    explanation:
      "La mano ha 15 HCP: ♠K+Q = 5, ♥A+J = 5, ♦Q = 2, ♣K = 3. Totale 15. L'apertura 2♣ è riservata a mani fortissime (22+ HCP o con enorme forza giocabile). Con 15-17 bilanciata l'apertura corretta è 1NT.",
  },
  ...
  // ============================================================
  {
    ...
    difficulty: "medio",
    situation:
      "Nord apre 1♥. Sud risponde 2♥ con 10 HCP e 4 carte di appoggio. Nord rilancia con 3♥ (invito a manche). Sud passa. Qual è l'errore?",
    ...
    correctAnswer: 2,
    explanation:
      "Con 10 HCP (♠K = 3, ♥Q+J = 3, ♦A = 4), 4 atout e un Asso laterale, Sud ha il massimo del suo rialzo a 2♥ (5-10 HCP). Quando l'apertore invita con 3♥ mostrando 16-17 HCP, il totale di coppia è almeno 26-27: manche sicura. Con il minimo (5-7) si passa, con il massimo (8-10) si accetta e si dichiara 4♥.",
  },
  {
    id: 12,
    category: "licita",
    difficulty: "medio",
    situation:
      "Nord apre 1NT (15-17). Sud ha 12 HCP e mano bilanciata. Risponde 2NT (invito). Qual è l'errore?",
    ...
    correctAnswer: 2,
    explanation:
      "Dopo 1NT (15-17), con 12 HCP (♠K+J = 4, ♥A = 4, ♦Q = 2, ♣Q = 2. Totale 12) il totale minimo in coppia è 15+12 = 27, ampiamente sufficiente per 3NT (servono 25). La risposta 2NT è un invito che mostra 8-9 HCP. Con 12 HCP bilanciata senza maggiore quarto, la risposta corretta è 3NT diretta.",
  },
  {
    id: 13,
    category: "licita",
    difficulty: "medio",
    situation:
      "Nord apre 1NT (15-17). Sud risponde 2♦ (transfer per cuori) con questa mano. Nord completa con 2♥. Sud dichiara Passo. Qual è l'errore?",
  ...
  },
  {
    ...
    difficulty: "medio",
    situation:
      "Est apre 1♠. Sud interviene 2♥ con questa mano. Qual è l'errore?",
    ...
    correctAnswer: 1,
    explanation:
      "Per un intervento a colore a livello 2 servono almeno 5 carte nel colore e un colore onorato. Con sole 4 cuori, 2♥ è scorretto. Con 11 HCP (♠J = 1, ♥K+Q = 5, ♦A = 4, ♣J = 1) e tolleranza per i colori non dichiarati, la scelta migliore è il Contro informativo.",
  },
  {
    id: 15,
    category: "gioco",
    difficulty: "medio",
    situation:
      "Contratto 3NT. Ovest attacca il 5♠. Al morto: ♠K82. In mano: ♠A94. Il dichiarante gioca il K♠ dal morto alla prima presa. Qual è l'errore?",
  ...
  },
  {
    ...
    difficulty: "medio",
    situation:
      "Contratto 4♠. Il dichiarante vuole fare l'impasse al Re di quadri. Al morto: ♦AQ5. In mano: ♦743. Gioca la Donna dal morto come prima carta. Qual è l'errore?",
  ...
  },
  {
    ...
    difficulty: "medio",
    situation:
      "Nord apre 1♥. Sud ha 16 HCP e 4 carte di cuori. Risponde direttamente 3♥. Qual è l'errore?",
    ...
    correctAnswer: 2,
    explanation:
      "Con 16 HCP (♠A = 4, ♥K+Q = 5, ♦A+J = 5, ♣Q = 2) e 4 carte di appoggio, la coppia ha almeno 28 HCP. La risposta 3♥ è un invito limitato a 10-11 HCP. Con 16 HCP si deve prima dichiarare un colore nuovo forzante (es. 2♦) per poi appoggiare o esplorare lo slam. Saltare direttamente a 3♥ sottovaluta gravemente la mano.",
  },
  {
    id: 18,
    category: "gioco",
    difficulty: "medio",
    situation:
      "Contratto 3NT. Il dichiarante ha bisogno di 4 prese dai fiori per fare il contratto. Al morto: ♣KQJ82. In mano: ♣73. Invece di giocare fiori, il dichiarante incassa A♠, A♥, A♦ (le vincenti laterali). Qual è l'errore?",
    ...
    correctAnswer: 0,
    explanation:
      "A Senza Atout, la regola fondamentale è: PRIMA sviluppa il colore che ti darà le prese necessarie (fiori), POI incassa. Se incassi A♠, A♥, A♦ prima, butti via le entrate al morto. Quando poi giochi fiori e l'avversario prende con l'Asso, non hai più modo di raggiungere le fiori affrancate al morto. Bisogna cedere la presa a fiori subito, mantenendo le entrate.",
  },
  {
    id: 19,
    category: "difesa",
    difficulty: "medio",
    situation:
      "Sud gioca 4♠. Ovest ha ♠KQJ103 e attacca il 3♠. Qual è l'errore nell'attacco?",
    ...
    correctAnswer: 1,
    explanation:
      "Con una sequenza di onori consecutivi (KQJ), si attacca con il più alto della sequenza: il K. Il K promette la Q e nega l'A. L'attacco della quarta migliore si usa per colori senza sequenza solida. Contro un contratto ad atout bastano due onori contigui per l'attacco dall'alto, e qui ce ne sono tre (KQJ).",
  },
  {
    id: 20,
    category: "licita",
    difficulty: "medio",
    situation:
      "Nord apre 1NT (15-17). Sud ha 10 HCP, 5 picche e risponde 2♠ naturale. Qual è l'errore?",
    cards: "♠KQ973 ♥84 ♦A63 ♣J52",
    sequence: ["1NT", "Passo", "2♠"],
    errorDescription: "Ha detto 2♠ naturale, ma su 1NT la risposta 2♠ è conclusiva e debole (0-7)",
    options: [
  ...
  },
  {
    ...
    difficulty: "medio",
    situation:
      "Compagno (Ovest) attacca il K♦ contro 3NT. Al morto c'è ♦854. Est ha ♦A72. Il dichiarante gioca piccola. Est gioca il 2♦. Qual è l'errore?",
  ...
  },
  {
    ...
    difficulty: "medio",
    situation:
      "Nord apre 1♥. Est passa. Sud ha 6 HCP e 5 picche ma risponde Passo. Qual è l'errore?",
  ...
  // ============================================================
  {
    ...
    situation:
      "La sequenza è: 1♠-Passo-2♣-Passo-2♠-Passo-4♠. Il rispondente ha 17 HCP e fit. Ha chiuso a 4♠ senza esplorare lo slam. Qual è l'errore?",
    ...
    correctAnswer: 1,
    explanation:
      "Con 17 HCP (♠K+Q = 5, ♥A = 4, ♦K = 3, ♣A+J = 5), fit a picche e un buon colore di fiori, lo slam è possibile. Dopo la risposta 2♣ (forzante a manche, 12+ HCP), la coppia ha almeno 29 HCP. Chiudere a 4♠ tronca il dialogo. Meglio dichiarare 3♠ (forzante, mostra fit e interesse slam) per permettere cue bid e richiesta d'Assi.",
  },
  {
    id: 24,
    category: "licita",
    difficulty: "difficile",
    situation:
      "Sequenza: 1♥-Passo-2♦-Passo-2NT. L'apertore ha ribattuto 2NT dopo una risposta 2 su 1. Qual è l'errore dell'apertore?",
  ...
  },
  {
    ...
    difficulty: "difficile",
    situation:
      "Sud gioca 3NT. Ovest attacca il 5♥. Al morto ♥K63. Est ha ♥AJ92. Il morto gioca il 3. Est vince col J♥. Qual è l'errore?",
  ...
  },
  {
    ...
    difficulty: "difficile",
    situation:
      "Contratto 4♠. Mano: ♠AKQJ5 ♣K83. Morto: ♠974 ♣62. Il dichiarante ha 2 perdenti a fiori. Prima di tagliare, batte 3 giri di atout. Al morto non restano più atout. Qual è l'errore?",
  ...
  },
  {
    ...
    difficulty: "difficile",
    situation:
      "Sud gioca 4♥. Ovest ha ♣AK84. Incassa A♣. Est gioca il 2♣. Ovest continua con K♣. Qual è l'errore?",
    ...
    correctAnswer: 2,
    explanation:
      "Nel sistema italiano pari-dispari, il 2♣ (carta pari) è un segnale di SGRADIMENTO: Est non vuole la continuazione di fiori. Probabilmente non ha la Q♣ e non ha un doubleton per tagliare. Ovest deve rispettare il segnale e cambiare colore, cercando il punto di entrata del compagno in un altro seme per poi tornare a fiori per il taglio, oppure sviluppare un altro colore.",
  },
  {
    id: 28,
    category: "licita",
    difficulty: "difficile",
    situation:
      "Sequenza: 1♣-Passo-1♥-1♠-? L'apertore con 17 HCP e fit quarto a cuori dichiara Passo. Qual è l'errore?",
  ...
  },
  {
    ...
    difficulty: "difficile",
    situation:
      "Contratto 3NT. Il dichiarante ha 7 vincenti e deve trovarne 2. Al morto: ♣A96543. In mano: ♣K2. Gioca A♣, K♣, poi il terzo giro. Fiori sono 4-2 e non si affrancano al terzo giro. Qual è l'errore?",
  ...
  },
  {
    ...
    difficulty: "difficile",
    situation:
      "Sequenza: 2♠*-3♠. L'apertura 2♠ è una sottoapertura (6 carte, 6-10 HCP). Il rispondente con 12 HCP e fit terzo rialza a 3♠ pensando di invitare. Qual è l'errore?",
    cards: "♠K84 ♥AQ5 ♦K973 ♣962",
    sequence: ["2♠", "Passo", "3♠"],
    errorDescription: "3♠ su sottoapertura è competitivo/decisionale, non invitante",
    options: [
  ...
  },
  {
    ...
    difficulty: "difficile",
    situation:
      "Sud gioca 4♠. Ovest ha ♠A874 e vede al morto ♠KQJ109 senza entrate laterali. Il dichiarante gioca il K♠ dal morto. Ovest non prende con l'Asso. Qual è l'errore?",
    ...
    correctAnswer: 1,
    explanation:
      "Al morto ci sono 5 picche (KQJT9) ma nessuna entrata laterale. Se Ovest ducka l'Asso, il dichiarante continua picche dal morto finché l'Asso non viene preso, e intanto sviluppa le sue prese. Se Ovest prende l'Asso SUBITO alla prima presa, il dichiarante non ha più piccole picche dalla mano per tornare al morto (se ha solo 2-3 picche), tagliando così la comunicazione con le picche franche.",
  },
  {
    id: 32,
    category: "gioco",
    difficulty: "difficile",
    situation:
      "Contratto 6♥. Le atout sono ♥AKQ93 in mano e ♥J74 al morto. Il dichiarante gioca A♥, K♥, Q♥, J♥ (4 giri). Le atout avversarie erano 3-2 e sono cadute dopo 3 giri. Qual è l'errore?",
    ...
    correctAnswer: 1,
    explanation:
      "Con 8 atout in linea (5+3), gli avversari ne hanno 5. Con divisione 3-2 (68% di probabilità), dopo 3 giri tutte le atout avversarie sono cadute. Il quarto giro è uno spreco di tempo: consuma un'atout vostra che poteva servire per tagliare o controllare un colore. In uno slam, ogni tempo è prezioso. Bisogna CONTARE le atout avversarie: dopo A, K, Q ne avete viste 5 nemiche? Allora basta.",
  },
];
